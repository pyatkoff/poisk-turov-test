...
| INT #1717 | A1 API ac9f1606 published34466239147;713 observed hotels, PERA ROSE11 variants and saved detail open/hide accepted. A2 existing #1846 resolver promoted unchanged into offer_detail: selected_offer plus current accepted identity/activity/country/target check; code pending CI, not published. Audit reports/andromeda-detail-selection-20260910.json | Check two-file API/module package and handoff; do not replay fixed-hash #1867 publisher. Shared global error handler still unconditionally reports failure without retained-provider context; SEARCH owns repair. A3 real package/verified price, selected UI and mobile/Safari deferred. No matching/booking/leads |
