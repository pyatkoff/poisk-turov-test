...
| INT #1717 | Официальная wiki auth/search прочитана, PDF не нужен. Draft1763: auth/справочники/HTTPS/CLI probe, source860cd5e5cb891f5af15bba44f4c0cbb5190441d6; offline CI34360654617 и Security34360654636 passed. Независимый draft1761: provider context59 и ANEX regression passed; runtime consumer отсутствует | Не повторять подготовку. Следом приватное подключение credentials и контролируемый login+townfrom с сохранением reservation/readback; затем реальные fixtures/адаптер. API calls0, live auth не проверена. Draft1763/1761 не merge автоматически: app/integrations push запускает ANEX workflow. Текущая зависимость — секрет и точный механизм запуска, не docs. Audit: reports/andromeda-client-readiness-20260909.json |
