...
| INT #1717 | Public paginated Andromeda search, ANEX-only mode and accepted upstream hotel filter published; DB586accepted/316pending/3conflict. Minimum-star filter now retains unresolved cards using supplier category:59 saved pages,61 retained namespaced groups at4+ stars (historical snapshots, not new mappings). Runtimec9f56ca55cc29a7e62a2675b7ebda6f15e239f52, deploy34385871759, protocol/security passed; supplier0/SQL0. draft1781, reports/andromeda-category-filter-20260909.json | Next: remaining form criteria/countries and source-qualified selection handoff. Direct SAMO photos unverified. Preserve Empire/Roulette, completed imports and failed447 checkpoint; no replay. Local hotel/region/rating filters still require accepted identity. Default operators and production/whole-site unchanged. |
