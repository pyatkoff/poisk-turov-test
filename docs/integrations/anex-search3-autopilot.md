...
| INT #1717 | Public scoped search has pagination and independent unresolved cards. DB586accepted/316pending/3conflict; latest two identities447/9365 accepted with preserved prior evidence. ANEX-only query link passes OPERATORS=5:2/2pages,97offers,31hotels. Photos for both newly mapped hotels verified from Tourvisor; late supplier content retention and image fallback fixed. Runtime544366a2008222bab0ba7b594026243326a9a112, deploy34383446650; draft1781, reports/andromeda-anex-media-20260909.json | Next: remaining form criteria/countries and source-qualified selection handoff. Direct SAMO photo availability still unverified. Preserve Empire catalog/price conflict and two Roulette identities. User wants correlation searches scoped to ANEX; default multi-operator search remains unchanged. Do not replay completed catalog import/captures. |
