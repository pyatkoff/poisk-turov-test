...
| INT #1717 | A1 API #1863 ac9f1606 PUBLISHED run34466239147 via approved #1867 main7384ffc3; hash53ce2e6f and backup07d8d901 verified, checkpoint artifact10147623229. One fresh Moscow–Turkey21Sep/7n/2adult UI search:713 visible hotels (completion unconfirmed); PERA ROSE ANEX103375RUB expanded11 variants, saved detail opened/hidden with variants retained. Desktop inspected. Audit reports/andromeda-projection-publication-gate-20260910.json | Preserve successful publication; no replay. Diagnose generic error banner coexisting with results (failing source unknown), handoff unloaded photo to SEARCH. A2 context / A3 real package and verified tourist price still separate; mobile/Safari deferred. No matching, booking or lead submissions; no whole-site publication |
