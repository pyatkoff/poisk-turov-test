...
| INT #1717 | API + selected-offer module #1873 eaf16ed7 published34469274568 via owner-approved #1878/main26b1af10; both hashes and backup verified, artifact10148826093. One fresh22Sep/7n/2adult common-preview search: CONSTANTINOPOLIS HOTEL/Anex Tour83080RUB saved details open and return accepted; quote unverified. Audit reports/andromeda-detail-publication-20260910.json | A3 remains private capture before quote/UI: fix confirmed #1837 result-state union bug with one offline lifecycle fixture; historical live probe not executable as-is (fresh-price selection/private evidence handling need review). No replay, matching or booking. SEARCH owns selected-tour UI and global error handler; mobile/Safari and full pagination completion deferred |
