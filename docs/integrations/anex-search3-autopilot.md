...
| INT #1717 | Public paginated search; DB586accepted/316pending/3conflict. ANEX-only mode verified97offers/31hotels. Accepted selected local hotel IDs now map to upstream HOTELS with full-coverage fallback; runtimeb0440edafe54cc9c413c8c999b52a69cd6965cd3, deploy34385124698. Real Life9365→416247 + OPERATORS5 returned8offers/1page; cached resume identical with unchanged request budget. Full handler/store tests and Security passed; draft1781, reports/andromeda-hotel-filter-20260909.json | Next: remaining form criteria/countries and source-qualified selection handoff. Direct SAMO photo availability remains unverified. Preserve Empire/Roulette and failed Verginia point checkpoint; do not replay captures/imports. Default operators unchanged. No production/whole-site replacement. |
