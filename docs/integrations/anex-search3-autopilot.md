...
| INT #1717 | Auth/live проверены. Catalog stage run34362120510/job102501480839 success: Москва1→Египет3;270departures/91countries,24operators/905hotels/51towns,4calls. Полные townfrom/state/all с digests/readback сохранены artifact10108261911; executable6cba9861544a607c233efcf17147392dd1834de5. Draft1763 не опубликован;1761 context готов | Далее read-only разбор сохранённого artifact: operator IDs/даты/валюты/отели, затем bounded price request/normalizer. Catalog capture завершён, повторных supplier reads не делать. Prices/DB/UI не включены. Runtime merge по-прежнему требует учёта ANEX push trigger. Audit: reports/andromeda-catalog-capture-20260909.json |
