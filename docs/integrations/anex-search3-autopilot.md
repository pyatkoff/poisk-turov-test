...
| INT #1717 | A1 projection fixed #1863 ac9f1606; contract34463350468/Security34463350411 passed; candidate artifact10146455195 remains unpublished. #1866 publisher c816582a passed offline34464751692/Security34464751737: fixed single API, predecessor/hash/backup/private checkpoint/readback. #1867 manual-only main launcher 8589d726 passed Security34465241572; draft, not merged. Audit reports/andromeda-projection-publication-gate-20260910.json. A2 context-only; A3 package separate | Owner approval for exact #1867 main launcher, then authorized manual GitHub Actions dispatch (connector unavailable); preserve receipt/hash before common-preview variants/details/return acceptance. No whole-site artifact or production publication, matching, supplier requests or unknown replay. Main approval does not approve broninit; UI remains SEARCH-owned |
