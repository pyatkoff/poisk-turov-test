...
| INT #1717 | API + selected-offer module #1873 eaf16ed7 published34469274568/artifact10148826093; CONSTANTINOPOLIS HOTEL/Anex Tour83080RUB fresh saved details→return accepted. #1881 fixes historical probe false failure; offline34470619745/Security34470619546 passed. A3 CLI bridge #1883 source2941baa2 checked offline34471435733/Security34471435671: exact retained store/private auth/existing counter + durable source checkpoint, default off; audit reports/andromeda-saved-package-runtime-20260910.json | Approved private invocation with current mapping reader/package-enabled transport and one explicitly selected fresh retained offer. Raw response stays private; receipt only. No historical #1837 first-price substitution, no unknown replay. Real composition/quote, shared selection UI and mobile/Safari deferred; SEARCH owns UI |
