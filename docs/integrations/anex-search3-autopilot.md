...
| INT #1717 | Реальный доступ, справочники и один PAGE1 price сохранены; disabled normalizer50/50. Private offer snapshots + accepted-only hotel resolver готовы на sourceb62a70487ec25a12e83675277306f2dc0ffdd512: raw offer ID остаётся на сервере, поиск/generation/15min expiry/2MiB/replay guards, mapping-version pinned, selection=false. CI34368860979 + Security34368860995 success; store24/resolver13 и прежние проверки зелёные, artifact10111024073 | Следующий bounded этап: read-only кандидаты для 46 catalog hotel IDs из сохранённого ответа и отдельные explicit accepted Andromeda identities. Затем согласованный SEARCH handoff. Операторские hotel IDs/roulette не связывать автоматически; supplier повтор не нужен; draft1763 не опубликован |
