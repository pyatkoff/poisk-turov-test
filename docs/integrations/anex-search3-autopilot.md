...
| INT #1717 | Owner enabled ANEX; same checked614aaffe criteria now return50 prices on PAGE1/PAGES_COUNT2. Run34365549508/job102513198643 success, artifact10109677472. Previous empty result retained. Login+price2calls only; raw response digest/readback verified | Next: offline inspection and normalizer of saved real price response, preserve operator hotel-key provenance and unknown fees; no need to rerun or fetch page2 for fixtures. Draft1763 remains disabled/unpublished. Audit reports/andromeda-enabled-price-20260909.json |
