...
- Prioritize measured removal of large duplicate CSS/JS blocks. Main CSS is
  179464 of the current 311687 generated bytes. Add micro-savings opportunistically;
  do not open separate PR/deploy/browser cycles for them.
- Report net generated bytes and distinguish checked from published work.
