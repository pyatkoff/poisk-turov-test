...
# Current product checkpoint — hot/month handoff business dates #1699/#1700 — 2026-09-09

Two sequential source packets complete `S3_PRODUCT_PAGES_HANDOFF`. #1699 aligns hot-tour CTA dates with the existing Europe/Moscow offer business day. #1700 moves country/resort month-page windows to the same canonical helper, clamps expired month portions and removes the duplicate server-timezone `tomorrow` calculation from the seasonal renderer. Checked release is `b3da2002305b14a97d058de1d4b0edbe053c622a`; sources are `cbeaab4fc07f5c0ded25a50abbec301cc8ea25b2` and `e90286ed063b66e0c22845c6f8d22b002ce47e70`.

Eight public Search3 assets and initial/full external CSS/JS are unchanged (0 B). Security 34328003803/34328644467 and exact 34328173433/34328788619 passed; boundary 34328173404 and standalone 34328173427 also passed. Exact PHP smoke covers both sides of Moscow midnight, month start/expiry and year rollover. No lead was submitted.

This nonvisual correction was not published. Preview remains source `8382d1bd8543fd3f0efb623673d1b70fa2be823d`; main observed `41ec8876c5c92a4a9d1b71d7387dcae6b5efee66`, main/production unchanged. Next active task is `S3_PRODUCT_USEFUL_FEATURES`: audit the existing public/Search3 price-calendar path for one confirmed usability/state mismatch, without repeating completed local facets or duplicating ANEX work. Audit: `docs/project/search3-pages-handoff-product.json`.
