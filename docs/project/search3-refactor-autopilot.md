...
Exact code head: `41c27412b21d1a2e7184376c2c187d325a6485ac`.
...
Focused price-input and filter-ownership regressions pass, the generated assets match their sources, and all 23 applicable PR workflows passed with one expected migration-only skip. Core run: `34012118544`; responsive visual run: `34012118653`, artifact `9982790892`, digest `sha256:50c1e604aa36c8f1f1e19e541b7654ad236278f8e3f0f4ab62d3d7a5a10bf74b`; whole-site artifact run: `34012118533`, artifact `9982787219`, digest `sha256:81a996dd8109c853e233945bb02a9046adfba8578bbf281ddc213aeec570fe42`.

At this code head, the four public CSS assets are 366,267 bytes / 4,196 physical lines; the four public JS assets are 158,180 bytes / 1,917 lines. Total: 524,447 bytes / 6,113 lines, uncompressed, excluding shared runtime and legacy and without double-counting `src` and generated `v2` files. Compared with the `2d4cd972` checkpoint, the active eight-asset set is 13,120 bytes and 83 lines smaller; this aggregate includes both the JS work and the independently completed orphan CSS/lifecycle cleanup, so it is not attributed to one commit or presented as a measured page-load gain.
