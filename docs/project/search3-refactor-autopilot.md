...
Exact code head: `35e2ae362856439b145829ce5139bbbe907e3327`.
...
Focused price-input and filter-ownership regressions pass, the generated assets match their sources, and all 23 applicable PR workflows passed with one expected migration-only skip. Core run: `34002187233`; responsive visual run: `34002187389`; whole-site artifact run: `34002187181`, artifact `9979820165`, digest `sha256:d0935a52ce77d7e06fc748c33e74fec005f56f3a88b8b6d7c330772a493b1785`.

At this code head, the four public CSS assets are 366,267 bytes / 4,196 physical lines; the four public JS assets are 157,436 bytes / 1,915 lines. Total: 523,703 bytes / 6,111 lines, uncompressed, excluding shared runtime and legacy and without double-counting `src` and generated `v2` files. Compared with the `2d4cd972` checkpoint, the active eight-asset set is 13,864 bytes and 85 lines smaller; this aggregate includes both the JS work and the independently completed orphan CSS/lifecycle cleanup, so it is not attributed to one commit or presented as a measured page-load gain.
