...
Exact code head: `243d0515def3d24efd5b2c45faffcd918cbc1866`.
...
Focused price-input and filter-ownership regressions pass, the generated assets match their sources, and all 23 applicable PR workflows passed with one expected migration-only skip. Core run: `34014662414`; responsive visual run: `34014662410`, artifact `9983532656`, digest `sha256:e02b0adf09206b96aa96add622afe71b6e2ee66149ae18bf19c401fc80786f19`; whole-site artifact run: `34014662488`, artifact `9983528616`, digest `sha256:6cc8dd2e71f747b2cfe86cac0fc12fb3d982e2944310a7ca206a4f2e72264264`.

At this code head, the four public CSS assets are 366,267 bytes / 4,196 physical lines; the four public JS assets are 158,295 bytes / 1,918 lines. Total: 524,562 bytes / 6,114 lines, uncompressed, excluding shared runtime and legacy and without double-counting `src` and generated `v2` files. Compared with the `2d4cd972` checkpoint, the active eight-asset set is 13,005 bytes and 82 lines smaller; this aggregate includes both the JS work and the independently completed orphan CSS/lifecycle cleanup, so it is not attributed to one commit or presented as a measured page-load gain.
