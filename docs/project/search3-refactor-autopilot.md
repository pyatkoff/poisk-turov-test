...
Exact code head: `35207333448e6d6301c82666b9507f428b86d007`.
...
Focused price-input and filter-ownership regressions pass, the generated assets match their sources, and all 23 applicable PR workflows passed with one expected migration-only skip. Core run: `34002590493`; responsive visual run: `34002590488`; whole-site artifact run: `34002590574`, artifact `9979930549`, digest `sha256:4c10b596f3950d233841ab831385120a4f1f319db7deb56a7b8a5bece59f619f`.

At this code head, the four public CSS assets are 366,267 bytes / 4,196 physical lines; the four public JS assets are 157,474 bytes / 1,915 lines. Total: 523,741 bytes / 6,111 lines, uncompressed, excluding shared runtime and legacy and without double-counting `src` and generated `v2` files. Compared with the `2d4cd972` checkpoint, the active eight-asset set is 13,826 bytes and 85 lines smaller; this aggregate includes both the JS work and the independently completed orphan CSS/lifecycle cleanup, so it is not attributed to one commit or presented as a measured page-load gain.
