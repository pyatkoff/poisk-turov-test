...
Exact code head: `a8ae0202e9c2777144018f41b5d10cc28370775a`.
...
Focused price-input and filter-ownership regressions pass, the generated assets match their sources, and all 23 applicable PR workflows passed with one expected migration-only skip. Core run: `34009770051`; responsive visual run: `34009769978`, artifact `9982102620`, digest `sha256:146bfc030442aec8012d0579dd0ef1a30e7a334e69205d1c6f8dee5db7e5830d`; whole-site artifact run: `34009770050`, artifact `9982099789`, digest `sha256:5134ca393436b88360f1ffdb6222e78741725531712f16b0cad793a72ed464c2`.

At this code head, the four public CSS assets are 366,267 bytes / 4,196 physical lines; the four public JS assets are 157,992 bytes / 1,917 lines. Total: 524,259 bytes / 6,113 lines, uncompressed, excluding shared runtime and legacy and without double-counting `src` and generated `v2` files. Compared with the `2d4cd972` checkpoint, the active eight-asset set is 13,308 bytes and 83 lines smaller; this aggregate includes both the JS work and the independently completed orphan CSS/lifecycle cleanup, so it is not attributed to one commit or presented as a measured page-load gain.
