...
Exact code head: `21bf320c5524edde4995d2c3c349d978f7434dae`.
...
Focused price-input and filter-ownership regressions pass, the generated assets match their sources, and all 23 applicable PR workflows passed with one expected migration-only skip. Core run: `34010029946`; responsive visual run: `34010030005`, artifact `9982175793`, digest `sha256:8bb62df29320210dcbca92868d5c2c8b3dc7a6511c631abdcbe6b0b5c800a3de`; whole-site artifact run: `34010029986`, artifact `9982172594`, digest `sha256:1102f6aeac334e966d6e490dcba2487cca43c860efda6f6896e9b959bdf3f54a`.

At this code head, the four public CSS assets are 366,267 bytes / 4,196 physical lines; the four public JS assets are 157,993 bytes / 1,917 lines. Total: 524,260 bytes / 6,113 lines, uncompressed, excluding shared runtime and legacy and without double-counting `src` and generated `v2` files. Compared with the `2d4cd972` checkpoint, the active eight-asset set is 13,307 bytes and 83 lines smaller; this aggregate includes both the JS work and the independently completed orphan CSS/lifecycle cleanup, so it is not attributed to one commit or presented as a measured page-load gain.
