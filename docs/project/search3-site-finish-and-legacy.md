...
Exact current published version: source `000f6a63052aba7c29efca6f0082cd6068ec188d`, tree `f257898ce159c5b38ea43256310bf4da02ebc7b9`, build `33938378885`, artifact `9960939157`, deployment `33938566550`, deployment draft #1344. The artifact contains 715 files; its ZIP, inner archive, manifest and payload-checksum hashes are recorded in `AUTOPILOT_STATE.json`. After a fresh reload, live checks confirmed content-addressed Search3 JS `d5646ea3…`, exact ages `0/17`, a completed real catalogue search with 80 hotels, an opened hotel, concrete operator offer, available flight, tour summary and visible lead form. No lead was submitted. Preview Metrika, external widget and lead delivery remain disabled; internal PHP/config paths are denied, protected production fingerprints remained unchanged, and the previous preview target was retained for rollback.
...
This correction is prepared in the release branch, not yet published in the coherent preview. The public whole-site preview still serves exact source `000f6a63052aba7c29efca6f0082cd6068ec188d`; main and production remain `fa58a0cba6dcfc8624d98c20d64fa06330eae309`.
