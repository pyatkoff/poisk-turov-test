...
function apply(){
  ...
  if(summary&&list.length)summary.textContent=(active()?'Показано отелей: '+shown+' из '+list.length:'Найдено отелей: '+list.length)+summary.textContent.slice(summary.textContent.indexOf(' · '));
