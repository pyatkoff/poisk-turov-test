...
function activeCount(){return[normalize(input.value),Number(categorySelect.value),mealSelect.value,budgetActive,Number(ratingSelect.value),Number(seaSelect.value)].filter(Boolean).length;}
