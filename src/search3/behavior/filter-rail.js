...
function schedulePriceApply(){if(priceApplyQueued)return;priceApplyQueued=true;window.requestAnimationFrame(function(){priceApplyQueued=false;apply();});}
