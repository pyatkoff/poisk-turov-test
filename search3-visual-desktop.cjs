...
(async()=>{
 ...
 const lifecycle=report.leadStates&&report.leadStates.sending&&report.leadStates.success&&report.leadStates.error;const search=report.search&&report.search.hasResults&&report.search.complete;const pass=report.http>0&&report.http<400&&search&&report.captureComplete&&report.tourDetailsReady&&report.tourDetailsConfidenceWide===true&&lifecycle&&report.errors.length===0;if(!pass){console.error('Desktop Search3 QA failed',JSON.stringify(report));process.exit(2)}
