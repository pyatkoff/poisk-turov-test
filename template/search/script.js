...
$(document).ready(function() {
	...
	ym(98615635, 'getClientID', function(cID) {
		clientID = cID;
	...
	if($("#hotelBlock .sCbList").length==0)
	{
		...
		data = { mode:"hotel", country: cn, stars:stars};
		if (region.length>0) 
			data.resort=region;
						...
						if (res.data.commerce==1)
						{
							...
							dataLayer.push({
								...
								if(res.data.p1 && res.data.p1>0)
									ym(98615635, 'reachGoal', 'PRAETOR',  {order_price: res.data.p1, currency: 'RUB'});
								if(res.data.p2 && res.data.p2>0)
									ym(98615635, 'reachGoal', 'PRAETOR2',  {order_price: res.data.p2, currency: 'RUB'});
								if(res.data.p3 && res.data.p3>0)
									ym(98615635, 'reachGoal', 'PRAETOR3',  {order_price: res.data.p3, currency: 'RUB'});
								if(res.data.p4 && res.data.p4>0)
									ym(98615635, 'reachGoal', 'PRAETOR4',  {order_price: res.data.p4, currency: 'RUB'});
								if(res.data.p5 && res.data.p5>0)
									ym(98615635, 'reachGoal', 'PRAETOR5',  {order_price: res.data.p5, currency: 'RUB'});
								if(res.data.p6 && res.data.p6>0)
									ym(98615635, 'reachGoal', 'PRAETOR6',  {order_price: res.data.p6, currency: 'RUB'});
								if(res.data.p7 && res.data.p7>0)
									ym(98615635, 'reachGoal', 'PRAETOR7',  {order_price: res.data.p7, currency: 'RUB'});
								if(res.data.p8 && res.data.p8>0)
									ym(98615635, 'reachGoal', 'PRAETOR8',  {order_price: res.data.p8, currency: 'RUB'});
								if(res.data.p9 && res.data.p9>0)
									ym(98615635, 'reachGoal', 'PRAETOR9',  {order_price: res.data.p9, currency: 'RUB'});
								if(res.data.p10 && res.data.p10>0)
									ym(98615635, 'reachGoal', 'PRAETOR10',  {order_price: res.data.p10, currency: 'RUB'});
...
function successCreate( data ) {
    ...
    if (data.data.commerce==1)
    {
	 ...
	 if (data.pretour)
    { 
		ym(98615635, 'reachGoal', 'PRETOUR',  {order_price: data.pretour, currency: 'RUB'} );
		    
		if(data.p1 && data.p1>0)
			ym(98615635, 'reachGoal', 'PRAETOR',  {order_price: data.p1, currency: 'RUB'});
		if(data.p2 && data.p2>0)
			ym(98615635, 'reachGoal', 'PRAETOR2',  {order_price: data.p2, currency: 'RUB'});
		if(data.p3 && data.p3>0)
			ym(98615635, 'reachGoal', 'PRAETOR3',  {order_price: data.p3, currency: 'RUB'});
		if(data.p4 && data.p4>0)
			ym(98615635, 'reachGoal', 'PRAETOR4',  {order_price: data.p4, currency: 'RUB'});
		if(data.p5 && data.p5>0)
			ym(98615635, 'reachGoal', 'PRAETOR5',  {order_price: data.p5, currency: 'RUB'});
		if(data.p6 && data.p6>0)
			ym(98615635, 'reachGoal', 'PRAETOR6',  {order_price: data.p6, currency: 'RUB'});
		if(data.p7 && data.p7>0)
			ym(98615635, 'reachGoal', 'PRAETOR7',  {order_price: data.p7, currency: 'RUB'});
		if(data.p8 && data.p8>0)
			ym(98615635, 'reachGoal', 'PRAETOR8',  {order_price: data.p8, currency: 'RUB'});
		if(data.p9 && data.p9>0)
			ym(98615635, 'reachGoal', 'PRAETOR9',  {order_price: data.p9, currency: 'RUB'});
		if(data.p10 && data.p10>0)
			ym(98615635, 'reachGoal', 'PRAETOR10',  {order_price: data.p10, currency: 'RUB'});
	}
...
function successUpdate( data ) {
    ...
    { 
		ym(98615635, 'reachGoal', 'HOTEL_PICK',  {order_price: data.pretour, currency: 'RUB'} );
		if(data.param_p1 && data.param_p1>0)
			ym(98615635, 'reachGoal', 'PRAETOR',  {order_price: data.param_p1, currency: 'RUB'});
		if(data.param_p2 && data.param_p2>0)
			ym(98615635, 'reachGoal', 'PRAETOR2',  {order_price: data.param_p2, currency: 'RUB'});
		if(data.param_p3 && data.param_p3>0)
			ym(98615635, 'reachGoal', 'PRAETOR3',  {order_price: data.param_p3, currency: 'RUB'});
		if(data.param_p4 && data.param_p4>0)
			ym(98615635, 'reachGoal', 'PRAETOR4',  {order_price: data.param_p4, currency: 'RUB'});
		if(data.param_p5 && data.param_p5>0)
			ym(98615635, 'reachGoal', 'PRAETOR5',  {order_price: data.param_p5, currency: 'RUB'});
		if(data.param_p6 && data.param_p6>0)
			ym(98615635, 'reachGoal', 'PRAETOR6',  {order_price: data.param_p6, currency: 'RUB'});
		if(data.param_p7 && data.param_p7>0)
			ym(98615635, 'reachGoal', 'PRAETOR7',  {order_price: data.param_p7, currency: 'RUB'});
		if(data.param_p8 && data.param_p8>0)
			ym(98615635, 'reachGoal', 'PRAETOR8',  {order_price: data.param_p8, currency: 'RUB'});
		if(data.param_p9 && data.param_p9>0)
			ym(98615635, 'reachGoal', 'PRAETOR9',  {order_price: data.param_p9, currency: 'RUB'});
		if(data.param_p10 && data.param_p10>0)
			ym(98615635, 'reachGoal', 'PRAETOR10',  {order_price: data.param_p10, currency: 'RUB'});
	}
...
function successTourInfoUpdate( data )
{
    ...
    if(data['data']['price_ecom'])
	{
		...
		ym(98615635, 'reachGoal', 'TOUR_OPEN',  {order_price: data['data']['price_ecom'], currency: 'RUB'});
		ym(98615635, 'reachGoal', 'TOUR_OPEN2', {order_price: data['data']['price_ecom2'], currency: 'RUB'});
		if(data['data']['p1'] && data['data']['p1']>0)
			ym(98615635, 'reachGoal', 'PRAETOR',  {order_price: data['data']['p1'], currency: 'RUB'});
		if(data['data']['p2'] && data['data']['p2']>0)
			ym(98615635, 'reachGoal', 'PRAETOR2',  {order_price: data['data']['p2'], currency: 'RUB'});
		if(data['data']['p3'] && data['data']['p3']>0)
			ym(98615635, 'reachGoal', 'PRAETOR3',  {order_price: data['data']['p3'], currency: 'RUB'});
		if(data['data']['p4'] && data['data']['p4']>0)
			ym(98615635, 'reachGoal', 'PRAETOR4',  {order_price: data['data']['p4'], currency: 'RUB'});
		if(data['data']['p5'] && data['data']['p5']>0)
			ym(98615635, 'reachGoal', 'PRAETOR5',  {order_price: data['data']['p5'], currency: 'RUB'});
		if(data['data']['p6'] && data['data']['p6']>0)
			ym(98615635, 'reachGoal', 'PRAETOR6',  {order_price: data['data']['p6'], currency: 'RUB'});
		if(data['data']['p7'] && data['data']['p7']>0)
			ym(98615635, 'reachGoal', 'PRAETOR7',  {order_price: data['data']['p7'], currency: 'RUB'});
		if(data['data']['p8'] && data['data']['p8']>0)
			ym(98615635, 'reachGoal', 'PRAETOR8',  {order_price: data['data']['p8'], currency: 'RUB'});
		if(data['data']['p9'] && data['data']['p9']>0)
			ym(98615635, 'reachGoal', 'PRAETOR9',  {order_price: data['data']['p9'], currency: 'RUB'});
		if(data['data']['p10'] && data['data']['p10']>0)
			ym(98615635, 'reachGoal', 'PRAETOR10',  {order_price: data['data']['p10'], currency: 'RUB'});
