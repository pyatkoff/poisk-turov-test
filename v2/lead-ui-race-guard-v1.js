...
function setPendingLocked(locked){setFlightLocked(locked);setReturnLocked(locked);setTourActionsLocked(locked);}
...
window.V2LeadUiRaceGuardV1={tourId,searchId,eventTourId,eventSearchId,isCurrent,protect,selectedRoot,flightChoices,returnAction,tourActions,setFlightLocked,setReturnLocked,setTourActionsLocked,setPendingLocked,startPending,clearPending,handleError,handleSuccess,get leadPending(){return leadPending;},version:5};
})();
