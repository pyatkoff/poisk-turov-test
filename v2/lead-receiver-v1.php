 ...
 * then invokes the production V2 lead adapter in-process using that session.
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    receiver_out(['ok' => true, 'receiver' => 'anytoour-hmac-bitrix-session', 'version' => 3]);
}
...
if ($sessid === '') receiver_out(['ok' => false, 'error' => 'Bitrix session unavailable'], 500);
...
// This handoff is reachable only after HMAC verification above. Public HTTP
// callers cannot define this PHP constant or inject the internal body global.
define('V2_INTERNAL_LEAD_RECEIVER', true);
$GLOBALS['V2_INTERNAL_LEAD_BODY'] = $forwardBody;
$_SERVER['REQUEST_METHOD'] = 'POST';
$_SERVER['CONTENT_TYPE'] = 'application/json';
$_SERVER['CONTENT_LENGTH'] = (string)strlen($forwardBody);
$_SERVER['HTTP_ORIGIN'] = 'https://anytour.online';
$_SERVER['HTTP_HOST'] = 'anytour.online';

require __DIR__ . '/lead-adapter-v2.php';
receiver_out(['ok' => false, 'error' => 'Lead adapter returned unexpectedly'], 500);
