...
var phoneLink=link(phoneHref,phoneText),mobileSupport=[phoneLink,'<span style="display:block;padding:0 0 8px;color:#c9d3e2;font-size:12px;line-height:1.4">Ежедневно 09:00 — 21:00</span>'];
...
footer.innerHTML='<div class="search3-footer-main"><div class="search3-footer-brand"><a class="search3-footer-logo" href="'+esc(logoHref)+'"><img src="'+esc(logoSrc)+'" alt="'+esc(logoAlt)+'"></a><strong>Путешествуй выгодно</strong><p>Поиск туров по всем туроператорам. Подберём лучший вариант и поможем с отдыхом.</p><div class="search3-footer-socials">'+socialLinks+'</div></div><div class="search3-footer-nav">'+group('Туры',tours)+group('Полезная информация',useful)+group('О компании',company)+group('Поддержка',mobileSupport,'search3-footer-support-mobile')+'</div><div class="search3-footer-support search3-footer-support-desktop"><strong>Поддержка</strong><span>Свяжитесь с нами</span>'+phoneLink+'<small>Ежедневно 09:00 — 21:00</small></div></div><div class="search3-footer-benefits"><div class="search3-footer-apps"><strong>Мобильные приложения</strong><span>Установите и ищите туры ещё удобнее</span><div>'+appLinks+'</div></div><div class="search3-footer-benefit"><b>◇</b><div><strong>Уточним детали</strong><span>Менеджер подтвердит детали до оплаты</span></div></div><div class="search3-footer-benefit"><b>▣</b><div><strong>Заявка без оплаты</strong><span>На этом шаге платить не нужно</span></div></div><div class="search3-footer-benefit"><b>◉</b><div><strong>Поддержка</strong><span>Ежедневно 09:00 — 21:00</span></div></div></div><div class="search3-footer-bottom"><span>© 2026 AnyTour — Все права защищены</span></div>';
