...
/**
 * CLI boundary for real search-performance exports covering the exact ten
 * country/resort/seasonal URLs in the controlled anytoour.ru SEO launch. This
 * command validates evidence only; it never invents missing metrics and never
 * changes indexation/publication.
 */
...
$output=[
    ...
    'launch_scope'=>$report['launch_scope']??'controlled_country_resort_seasonal_v3',
    'launched_path_count'=>$report['launched_path_count']??10,
