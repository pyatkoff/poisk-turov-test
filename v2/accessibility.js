...
function loadMobileResultsFilters(){if(window.V2MobileResultsFiltersV1||document.querySelector('script[data-v2-mobile-results-filters]'))return;const script=document.createElement('script');script.dataset.v2MobileResultsFilters='1';script.src='/poisk-turov-test/v2/mobile-results-filters-v1.js';script.defer=true;document.head.appendChild(script);}
loadMobileResultsFilters();
