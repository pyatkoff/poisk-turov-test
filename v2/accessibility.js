...
window.addEventListener('v2:tour-selected',()=>{if(selected){selected.setAttribute('tabindex','-1');selected.setAttribute('aria-label','Выбранный тур');}decorate(selected||document);});
...
window.V2Accessibility={decorate,closeSearchPanels,version:2};
})();