...
{
    return ['/country/egypt/','/country/maldives/'];
}
...
{
    return ['/country/turkey/antalya/september/','/country/maldives/september/'];
}

/** Fourth controlled wave: exact evidence-backed October seasonal pair only. */
function v2_seo_seasonal_october_launch_paths(): array
{
    return ['/country/turkey/antalya/october/','/country/maldives/october/'];
}
...
function v2_seo_controlled_launch_paths(): array
{
    return array_values(array_merge(
        ...
        v2_seo_seasonal_october_launch_paths()
    ));
}
...
function v2_seo_turkey_launch_sitemap_urls(array $catalog,bool $launchEnabled):array{return v2_seo_sitemap_candidate_urls($catalog,$launchEnabled,v2_seo_turkey_launch_paths());}
function v2_seo_turkey_launch_sitemap_xml(array $catalog,bool $launchEnabled):string{return v2_seo_sitemap_candidate_xml($catalog,$launchEnabled,v2_seo_turkey_launch_paths());}
function v2_seo_controlled_launch_sitemap_urls(array $catalog,bool $launchEnabled):array{return v2_seo_sitemap_candidate_urls($catalog,$launchEnabled,v2_seo_controlled_launch_paths());}
function v2_seo_controlled_launch_sitemap_xml(array $catalog,bool $launchEnabled):string{return v2_seo_sitemap_candidate_xml($catalog,$launchEnabled,v2_seo_controlled_launch_paths());}
