...
function v2_seo_content_pilot_maldives(): array
{
    return [
        ...
        'data' => [
            ...
            'sections' => [
                ['id'=>'island-choice','title'=>'Как выбрать остров и атолл','paragraphs'=>['Северный и Южный Мале, Ари, Баа, Раа и другие атоллы объединяют разные по формату острова и отели. Для первого отбора полезнее определить желаемый сценарий отдыха, чем выбирать только по названию атолла.','Обратите внимание на размер острова, характер пляжа, наличие рифа, инфраструктуру и формат размещения. Даже близкие по цене варианты могут давать совершенно разный отдых.']],
                ['id'=>'hotel-choice','title'=>'Отель, питание и категория номера','paragraphs'=>['На островном курорте возможности за пределами отеля ограничены, поэтому питание и инфраструктура комплекса особенно важны. Сравнивайте не только звёздность, но и конкретную концепцию отеля и состав включённых услуг.','Категория номера тоже существенно влияет на стоимость и формат поездки: варианты на пляже и над водой могут отличаться не только расположением, но и условиями размещения.']],
                ['id'=>'transfer','title'=>'Трансфер — часть выбора тура','paragraphs'=>['Способ и условия трансфера зависят от конкретного острова и предложения. При сравнении туров важно смотреть пакет целиком и проверять доступные сведения о перелёте, трансфере и размещении.','Не стоит делать вывод об итоговой стоимости только по цене отеля: перед заявкой нужно проверить состав конкретного турпакета.']],
            ...
            'related' => [
                ...
                ['label' => 'Туры в Taj Coral Reef Resort & Spa Maldives', 'href' => '/country/maldives/hotel/taj-coral-reef-resort-spa-maldives-2439/'],
                ['label' => 'Туры в Kagi Maldives Resort & Spa', 'href' => '/country/maldives/hotel/kagi-maldives-resort-spa-77570/'],
                ['label' => 'Туры в Grand Park Kodhipparu Maldives', 'href' => '/country/maldives/hotel/grand-park-kodhipparu-maldives-48640/'],
            ],
