...
style.textContent='@media(max-width:560px){.mobile-search-summary{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;align-items:center;margin:10px 0 12px;padding:10px 11px;background:#fff;border:1px solid #dfe5ef;border-radius:15px;box-shadow:0 8px 24px rgba(38,53,89,.08);position:sticky;top:6px;z-index:7}.mobile-search-summary[hidden]{display:none!important}.mobile-search-summary-main{min-width:0;border:0;background:transparent;padding:0;text-align:left;cursor:pointer}.mobile-search-summary-route{display:block;color:#273248;font-size:14px;font-weight:900;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.mobile-search-summary-meta{display:block;margin-top:3px;color:#7a8598;font-size:10px;font-weight:700;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.mobile-search-summary-edit{border:1px solid #cfd8ee;background:#f6f8ff;color:#3154cf;border-radius:10px;min-height:40px;padding:0 11px;font-size:12px;font-weight:900;cursor:pointer}.mobile-search-collapsed{display:none!important}.mobile-search-collapsed+.mobile-search-summary{margin-top:0}}';
