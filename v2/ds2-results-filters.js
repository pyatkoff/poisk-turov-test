...
function updateSummary(count){if(!summary)return;summary.textContent=count===sourceItems.length?'Найдено '+count+' '+hotelWord(count):'Подходит '+count+' из '+sourceItems.length+' '+hotelWord(sourceItems.length);}
...
function build(){rail.innerHTML='<div class="filter-rail-head"><div class="filter-rail-title">Фильтры</div><button type="button" class="filter-reset-link" data-ds2-reset>Сбросить</button></div><label class="filter-range"><span>Бюджет на тур</span><input type="range" data-ds2-price min="40000" max="250000" step="5000" value="250000"><small data-ds2-price-label>до 250 000 ₽</small></label><fieldset><legend>Питание</legend><label class="filter-option"><input type="radio" name="ds2-meal" value="" checked><span>Любое</span></label><label class="filter-option"><input type="radio" name="ds2-meal" value="ai"><span>Всё включено</span></label><label class="filter-option"><input type="radio" name="ds2-meal" value="hb"><span>Полупансион</span></label></fieldset><fieldset><legend>Категория отеля</legend><label class="filter-option"><input type="radio" name="ds2-stars" value="0" checked><span>Любая</span></label><label class="filter-option"><input type="radio" name="ds2-stars" value="5"><span>5★</span></label><label class="filter-option"><input type="radio" name="ds2-stars" value="4"><span>4★ и выше</span></label><label class="filter-option"><input type="radio" name="ds2-stars" value="3"><span>3★ и выше</span></label></fieldset><fieldset><legend>Рейтинг</legend><label class="filter-option"><input type="radio" name="ds2-rating" value="0" checked><span>Любой</span></label><label class="filter-option"><input type="radio" name="ds2-rating" value="4.5"><span>4.5+</span></label><label class="filter-option"><input type="radio" name="ds2-rating" value="4"><span>4.0+</span></label></fieldset><div class="filter-rail-result"><span>Подходит</span><strong><b data-ds2-filter-count>0</b> отелей</strong></div>';
...
window.DS2ResultsFilters={apply,reset,get state(){return Object.assign({},state);},version:2};
})();