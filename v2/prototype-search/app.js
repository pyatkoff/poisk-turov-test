...
const priceNote=o=>o.cached?'Сохранённая цена · требует проверки':needsRefresh(o)?'Цена из текущего поиска · требует подтверждения':'Цена предложения · сборы уточняются';
