...
groundBrandProof();
// Compatibility source-contract marker only: runtimePath('footer-current-site.css') is intentionally not requested; site-footer-v1.css is already in the active bundle.
