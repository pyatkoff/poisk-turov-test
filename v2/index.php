...
<script>window.V2_CONFIG={api:'/poisk-turov-test/v2/api.php',metrikaCounter:<?=json_encode($metrikaCounter,JSON_UNESCAPED_SLASHES)?>};</script><script src="<?=e(v2_asset('runtime-v2.js'))?>"></script><script src="<?=e(v2_asset('analytics.js'))?>"></script><script src="<?=e(v2_asset('results-renderer-v3.js'))?>"></script><script src="<?=e(v2_asset('search-continue-v3.js'))?>"></script><script src="<?=e(v2_asset('hotel-actions-v2.js'))?>"></script><script src="<?=e(v2_asset('room-details-v2.js'))?>"></script><script src="<?=e(v2_asset('tour-controller-v2.js'))?>"></script><script src="<?=e(v2_asset('catalogs-runtime.js'))?>"></script><script src="<?=e(v2_asset('search-lifecycle-v2.js'))?>"></script></body></html>