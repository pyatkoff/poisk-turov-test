...
function v2_seo_seasonal_review_content_prototypes(): array
{
    ...
    return [
        'antalya-september'=>[
            ...
            'title'=>'Туры в Анталью в сентябре: климатические ориентиры для поездки','h1'=>'Туры в Анталью в сентябре',
            'intro'=>'Для выбора тура в Анталью на сентябрь климатические ориентиры полезно сверять с официальной статистикой, а даты, состав пакета, стоимость и доступность — только с актуальной выдачей поиска AnyTour.',
            'sections'=>[
