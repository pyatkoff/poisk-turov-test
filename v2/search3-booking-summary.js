...
function money(v){const n=Number(v||0);return Number.isFinite(n)&&n>0?new Intl.NumberFormat('ru-RU').format(n)+' ₽':'—';}
...
'<div class="search3-booking-summary__total"><span>Стоимость тура</span><strong>'+money(t&&t.price)+'</strong></div></aside>';}
