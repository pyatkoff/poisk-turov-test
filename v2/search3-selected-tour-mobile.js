...
window.addEventListener('v2:tour-selected',function(){setTimeout(sync,0);});window.addEventListener('v2:selected-tour-opened',function(){setTimeout(sync,0);});window.addEventListener('v2:selected-tour-closed',function(){setTimeout(sync,0);});window.addEventListener('v2:results-rendered',function(){setTimeout(sync,0);});
