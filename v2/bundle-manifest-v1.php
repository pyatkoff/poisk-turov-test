...
function v2_bundle_files(string $type, string $scope = 'full'): array
{
    ...
    $excluded = [
        'css' => ['conversion-confidence-v1.css', 'mobile-search-summary-v1.css'],
        ...
        'js' => ['search-redesign-v2.js', 'conversion-confidence-v1.js', 'compare-refresh-guard-v1.js', 'mobile-search-summary-v1.js'],
    ];
