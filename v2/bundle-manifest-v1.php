...
function v2_bundle_files(string $type, string $scope = 'full'): array
{
    ...
    $excluded = [
        ...
        // only optional duplicate filter/calendar/autocomplete and hotel-detail presentation.
