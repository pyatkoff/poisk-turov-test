...
function v2_bundle_files(string $type, string $scope = 'full'): array
{
    ...
    $excluded = [
        'css' => ['conversion-confidence-v1.css', 'mobile-search-summary-v1.css', 'primary-meal-ux-v1.css', 'search-params-filter-rail-v1.css', 'search-shell-grid-v1.css', 'results-layout-guard-v1.css', 'search-header-layout-guard-v1.css', 'search-footer-rhythm-v1.css', 'ds2-search-tablet-filters-v1.css'],
