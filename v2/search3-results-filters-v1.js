...
function init(){
  ...
  var n1=refs.daysFrom,n2=refs.daysTill;if(n1&&n2){var nightBox=makeComposite('Ночей','search3-nights'),nightCtl=nightBox.querySelector('.search3-composite__control');n1.classList.add('search3-direct-control');n2.classList.add('search3-direct-control');n1.setAttribute('aria-label','Минимум ночей');n2.setAttribute('aria-label','Максимум ночей');[n1,n2].forEach(function(n){n.setAttribute('min','1');n.setAttribute('max','28');n.setAttribute('step','1');n.setAttribute('inputmode','numeric');});nightCtl.appendChild(n1);var nd=document.createElement('span');nd.className='search3-composite__dash';nd.textContent='—';nightCtl.appendChild(nd);nightCtl.appendChild(n2);main.appendChild(nightBox);}
