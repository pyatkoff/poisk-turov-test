...
<section aria-labelledby="hot-live-title" class="sp-hot-live-section">
  ...
  <div class="sp-note">Нажмите «Проверить варианты», чтобы запустить поиск по указанным датам и проверить актуальные предложения.</div>
</section>
<?php endif; ?>
<section>
...
<section>
  ...
  <div class="sp-grid sp-grid--balanced-three">
    ...
    <section class="sp-card"><h3>Проверяем перед заявкой</h3><p>Откройте конкретный тур — покажем детали и итоговую стоимость. Менеджер получит выбранные параметры только после отправки заявки.</p></section>
  </div>
</section>
