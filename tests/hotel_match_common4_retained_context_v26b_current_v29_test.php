...
require_once dirname(__DIR__).'/scripts/diagnostics/hotel_match_common4_retained_context_v26b_current_v29.php';
if(SBLC4C4_OP!=='hotel-match-common4-retained-context-v26b-current-1971-20260925-v29')throw new RuntimeException('operation');
...
echo "MATCH_COMMON4_RETAINED_CONTEXT_V26B_CURRENT_V29_TEST_OK\n";
