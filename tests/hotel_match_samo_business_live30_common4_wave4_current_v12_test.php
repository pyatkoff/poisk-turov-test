...
require_once dirname(__DIR__).'/scripts/diagnostics/hotel_match_samo_business_live30_common4_wave4_current_v12.php';
if(SBLC4C4_OP!=='hotel-match-samo-business-live30-common4-wave4-current-1971-20260925-v12')throw new RuntimeException('operation');
if(SBLC4C4_SOURCE_OP!=='hotel-match-samo-business-live30-common4-acquire-1971-20260924-v3-wave4')throw new RuntimeException('source_operation');
if(SBLC4C4_EXPECTED_EDGES!==1197||SBLC4C4_EXPECTED_CAPTURED!==22)throw new RuntimeException('counts');
$edges=[
...
echo "MATCH_SAMO_BUSINESS_LIVE30_WAVE4_CURRENT_V12_TEST_OK\n";
