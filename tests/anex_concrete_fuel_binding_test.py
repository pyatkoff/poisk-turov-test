...
value={
    ...
    'supplier_replay_allowed':False,'supplier_effect':'read_only_search_expand_flights_additional_tv_completed',
    'booking_calls':0,'broninit_calls':0,'mapping_writes':0,'andromeda_requests':0,
    'anex_requests':6,'tourvisor_requests':5,'additional_prices_requests':1,
    ...
    'additional_prices':{'data':[{'tour':2637,'currency':3,'dateBeg':'2026-10-19','nights':7,'price_adult':140,
...
for field,bad in [('booking_calls',1),('mapping_writes',1),('andromeda_requests',1),('additional_prices_requests',2)]:
...
assert "ANEX_CONCRETE_FUEL_DATE = '2026-10-19'" in php
