...
if(($r['state']??'')!=='production_identity_registry_valid'||($r['page_count']??0)!==11)fail_collector('valid');
if(($r['type_counts']['country']??0)!==3||($r['type_counts']['resort']??0)!==5||($r['type_counts']['seasonal']??0)!==2)fail_collector('controlled_scope');
...
echo "SEO_PRODUCTION_IDENTITY_COLLECTOR_OK pages=11 country=3 resort=5 seasonal=2 hotel_tours=noindex\n";
