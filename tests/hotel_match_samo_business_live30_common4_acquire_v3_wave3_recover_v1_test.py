...
p=pathlib.Path(__file__).resolve().parents[1]/"scripts/diagnostics/hotel_match_samo_business_live30_common4_acquire_v3_wave3_recover_v1.py"
...
print("MATCH_SAMO_BUSINESS_LIVE30_WAVE3_RECOVER_V1_TEST_OK")
