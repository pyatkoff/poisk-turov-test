...
if (strpos($resort, "'Подобрать тур в ' . \$resortDestination") === false || strpos($resort, 'v2_seo_resort_destination_name($rawPage)') === false || strpos($resort, "v2_seo_search_handoff_url('/poisk-turov/', \$page['search_state'])") === false || strpos($resort, 'sp-offer-meta') === false || strpos($resort, 'v2_seo_offer_price_markup($offer)') === false) {
