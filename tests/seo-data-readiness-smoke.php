...
if (($out['evidence_checked_at_epoch']??0)!==10002 || ($out['evidence_valid_until_epoch']??0)!==20000 || ($out['evidence_clock_valid']??false)!==true) data_ready_fail('evidence_clock');
...
echo "SEO_DATA_READINESS_SMOKE_OK countries=2 missing=1 usable=24 blocked=1 clock=1 publication=0\n";
