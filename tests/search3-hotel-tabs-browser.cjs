...
async function run(engine, width, height) {
  ...
  try {
    ...
    reports.push({ engine, width, height, sourceSha, passed: true, photoViewer: true, photoContextPreserved: true, photoErrorRecovery: true, photoSlowResponseRecovery: true, photoFocusContainment: true, searchStarts: 2, detailTabs: 3, directReload: true, expiredManualRecovery: true, expiredCanonicalProfile:true, expiredPhotoViewer:true, pastDateProfile:true, missingProfileRecovery:true, explicitRefresh:true, shortlistSelectedIsolation:true,shortlistCrossTab:true, shortlistStorageValidation:true, shortlistFocusPreserved:true, exactOffer: exact });
  } catch (error) {
