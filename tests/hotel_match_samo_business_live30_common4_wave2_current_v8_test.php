...
require_once dirname(__DIR__).'/scripts/diagnostics/hotel_match_samo_business_live30_common4_wave2_current_v8.php';
if(SBLC4C4_OP!=='hotel-match-samo-business-live30-common4-wave2-current-1971-20260924-v8')throw new RuntimeException('operation');
if(SBLC4C4_SOURCE_OP!=='hotel-match-samo-business-live30-common4-acquire-1971-20260924-v3-wave2')throw new RuntimeException('source_operation');
if(SBLC4C4_EXPECTED_EDGES!==1192||SBLC4C4_EXPECTED_CAPTURED!==17)throw new RuntimeException('counts');
$edges=[
...
echo "MATCH_SAMO_BUSINESS_LIVE30_WAVE2_CURRENT_V8_TEST_OK\n";
