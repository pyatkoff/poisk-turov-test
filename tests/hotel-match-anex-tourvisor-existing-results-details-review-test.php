...
$qDetail=['name'=>'Sunrise Garden Beach','region'=>'Хургада','town'=>'Хургада','latitude'=>null,'longitude'=>null];$qRow=$row;$qRow['name']='SUNRISE GARDEN';$qCat=$cat;$qCat['name']='SUNRISE GARDEN';$qCat['latitude']=null;$qCat['longitude']=null;$c=hmatv_candidate($qDetail,$qRow,$qCat,[],false);tvd_t($c===null,'BEACH qualifier loss must be rejected before candidate creation');
