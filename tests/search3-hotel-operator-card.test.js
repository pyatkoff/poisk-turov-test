...
assert.deepEqual(provenance.assets.map(asset=>asset.file).sort(),['anex.svg','biblio-globus.svg','coral.png','funsun.svg','intourist.png','sunmar.svg'],'all six rendered brands have original artwork provenance');
...
console.log('SEARCH3_OPERATOR_CARDS_OK collapsed_hotel_level=1 compact_exact_offers=1 brands=6 provider_not_operator=1 frozen_source=1');
