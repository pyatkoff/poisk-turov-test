...
require_once dirname(__DIR__).'/scripts/diagnostics/hotel_match_samo_business_live30_common4_wave3_current_v10.php';
if(SBLC4C4_OP!=='hotel-match-samo-business-live30-common4-wave3-current-1971-20260924-v10')throw new RuntimeException('operation');
if(SBLC4C4_SOURCE_OP!=='hotel-match-samo-business-live30-common4-acquire-1971-20260924-v3-wave3')throw new RuntimeException('source_operation');
if(SBLC4C4_EXPECTED_EDGES!==1200||SBLC4C4_EXPECTED_CAPTURED!==328)throw new RuntimeException('counts');
$edges=[
...
echo "MATCH_SAMO_BUSINESS_LIVE30_WAVE3_CURRENT_V10_TEST_OK\n";
