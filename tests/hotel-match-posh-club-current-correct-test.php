...
foreach(['2000042757','2000051422','2000073047','132075','131024','111423','evidence_sha256','cas_update_failed','postcommit_readback_failed','crystal_bay_changed'] as $needle){if(!str_contains($src,$needle)){fwrite(STDERR,"missing:$needle\n");exit(3);}}
