...
$tv=[$row(1,'SIDE YESILOZ HOTEL','funsun'),$row(2,'BLUE BEACH RESORT','anex'),$row(3,'SELENIUM HOTEL','biblio'),$row(4,'APOLLO HOTEL','intourist')];
$sa=[$row(11,'Side Yesiloz','funsun'),$row(12,'Blue Resort','anex'),$row(13,'Selenium Hotel','biblio'),$row(14,'Apolo Hotel','intourist')];
