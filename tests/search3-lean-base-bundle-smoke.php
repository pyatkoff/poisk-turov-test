...
if (array_values(array_diff($fullCss, $search3Css)) !== ['conversion-confidence-v1.css', 'primary-meal-ux-v1.css', 'mobile-search-summary-v1.css', 'search-params-filter-rail-v1.css', 'results-layout-guard-v1.css', 'search-header-layout-guard-v1.css']) lean_bundle_fail('unreviewed CSS scope delta');
