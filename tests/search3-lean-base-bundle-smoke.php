...
if (array_values(array_diff($fullCss, $search3Css)) !== ['enhancements.css', 'design-v1.css', 'hotel-details-design.css', 'tour-design-v1.css', 'anytour-brand.css', 'results-experience-v1.css', 'sales-leader-ui-v1.css', 'conversion-confidence-v1.css', 'checkout-experience-v1.css', 'header-current-site.css', 'primary-meal-ux-v1.css', 'search-progress-ux-v1.css', 'search-dirty-ux-v1.css', 'mobile-search-summary-v1.css', 'search-params-filter-rail-v1.css', 'product-shell-v1.css', 'search-shell-grid-v1.css', 'results-layout-guard-v1.css', 'search-header-layout-guard-v1.css', 'search-footer-rhythm-v1.css', 'search-header-shared-shell-v1.css', 'ds2-search-tablet-filters-v1.css', 'ds2-selected-tour-convergence-v1.css']) lean_bundle_fail('unreviewed CSS scope delta');
