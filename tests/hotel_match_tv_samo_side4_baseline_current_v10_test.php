...
if($pairs[0]['tier']!=='baseline_exact_common3'||$pairs[1]['tier']!=='baseline_exact_biblio_only'||$pairs[2]['tier']!=='baseline_exact_no_common3') throw new RuntimeException('tiers');
echo "ok\n";
