...
$base=['experiment_id'=>ANEX_THREE_PRICE_EXPERIMENT,'case_id'=>'anex','country'=>'Turkey','date'=>'2026-09-27','nights'=>7,
...
foreach([
    ['date','2026-09-20'],['nights',8],['adults',3],['meal_family','bb'],['currency','USD'],['country','Egypt'],['case_id','other']
