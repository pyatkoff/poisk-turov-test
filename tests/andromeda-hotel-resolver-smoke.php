...
badr(fn()=>AnyTourAndromedaHotelResolver::fromRows([$rows[2],$rows[2]],$v),'ANDROMEDA_MAPPING_INVALID');
$x=$rows[0];$x['external_hotel_id']='opaque-hotel-1';
okr(AnyTourAndromedaHotelResolver::fromRows([$x],$v)->version()===$v);
