...
class Search3HalfSizeResetTest(unittest.TestCase):
    ...
    def test_eight_public_paths_and_presentation_budget(self):
        ...
        self.assertLessEqual(total, 95000, 'eight presentation assets stay within the reviewed 95KB envelope including local nights/flight facets')
    ...
    def test_one_local_hotel_filter_owns_loaded_card_filtering(self):
        ...
        self.assertIn("seaField.hidden=seas.length<2||!s", source)
