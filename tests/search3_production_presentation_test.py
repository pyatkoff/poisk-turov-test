    ...
    def test_protected_core_files_and_hashes_remain_exact(self):
        ...
        for name in (
            ...
            if name == 'tour-controller-v4.js':
                ...
                fuel_helper = b"function flightFuelText(v){if(!v||!Object.prototype.hasOwnProperty.call(v,'fuelCharge')||v.fuelCharge===null||v.fuelCharge==='')return'\xd1\x83\xd1\x82\xd0\xbe\xd1\x87\xd0\xbd\xd1\x8f\xd0\xb5\xd1\x82\xd1\x81\xd1\x8f';const fuel=v.fuelCharge,raw=fuel&&typeof fuel==='object'&&fuel.value!==undefined?fuel.value:fuel;if(raw===null||raw==='')return'\xd1\x83\xd1\x82\xd0\xbe\xd1\x87\xd0\xbd\xd1\x8f\xd0\xb5\xd1\x82\xd1\x81\xd1\x8f';const n=Number(raw);if(!Number.isFinite(n)||n<0)return'\xd1\x83\xd1\x82\xd0\xbe\xd1\x87\xd0\xbd\xd1\x8f\xd0\xb5\xd1\x82\xd1\x81\xd1\x8f';return n?money(n)+' \xe2\x82\xbd':'\xd0\xb1\xd0\xb5\xd0\xb7 \xd0\xb4\xd0\xbe\xd0\xbf\xd0\xbb\xd0\xb0\xd1\x82\xd1\x8b';}\n"
                ...
                fuel_display = ("function fuelText(source){if(!source||!Object.prototype.hasOwnProperty.call(source,'fuelCharge')||source.fuelCharge===null||source.fuelCharge==='')return'уточняется';const fuel=source.fuelCharge,raw=fuel&&typeof fuel==='object'&&fuel.value!==undefined?fuel.value:fuel;if(raw===null||raw==='')return'уточняется';const value=Number(raw);if(!Number.isFinite(value)||value<0)return'уточняется';return value?money(value)+' ₽':'без доплаты';}\n"
