...
require_once __DIR__.'/../scripts/diagnostics/hotel_match_tv_samo_common4_weekly_resume_v3.php';
...
$source=(string)file_get_contents(__DIR__.'/../scripts/diagnostics/hotel_match_tv_samo_common4_weekly_v2.php');
...
file_put_contents($tmp.'/result.json',json_encode(['operation'=>HMC_PREVIOUS_OP,'state'=>'terminal_failed_no_replay','reason'=>'tv_continue_cap']));
...
echo "MATCH_TV_SAMO_COMMON4_WEEKLY_RESUME_V3_TEST_OK\n";
