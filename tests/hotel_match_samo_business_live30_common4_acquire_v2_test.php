...
require_once dirname(__DIR__).'/scripts/diagnostics/hotel_match_samo_business_live30_common4_acquire_v2.php';

if(SLC4A_OP!=='hotel-match-samo-business-live30-common4-acquire-1971-20260924-v2')throw new RuntimeException('operation');
...
if(SLC4A_CHECKIN_BEG!=='20260926'||SLC4A_CHECKIN_END!=='20261016')throw new RuntimeException('context');
...
echo "MATCH_SAMO_BUSINESS_LIVE30_COMMON4_ACQUIRE_V2_TEST_OK\n";
