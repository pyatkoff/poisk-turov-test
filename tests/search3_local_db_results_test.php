...
need($before===$after,'reader writes nothing');need($result['scopeDigest']===$scope['digest']&&$result['scopeVersion']===1,'exact scope echoed');need($result['storedOfferCount']===3&&$result['withheldOfferCount']===1,'inactive own profile withheld');
...
echo "SEARCH3_LOCAL_DB_RESULTS_OK scope_v1=1 stored=3 rendered=2 hotels=1 withheld=1 writes=0\n";
