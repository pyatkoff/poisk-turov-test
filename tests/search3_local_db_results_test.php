...
echo "SEARCH3_LOCAL_DB_RESULTS_OK scope_v1=1 store_v2=1 stored=3 rendered=2 hotels=1 withheld=1 revoked_identity_hidden=2 provider_map_object=1 writes=0\n";
