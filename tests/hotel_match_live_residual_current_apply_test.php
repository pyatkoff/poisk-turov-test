...
$p=mca_plan($review);at(count($p)===3,'eligible count');at(isset($p['operator_native|operator_342|10']),'operator eligible');at(!isset($p['operator_native|operator_5|11']),'operator5 excluded');at(isset($p['andromeda_catalog||20'])&&isset($p['andromeda_catalog||21']),'catalog exact/fuzzy eligible');
