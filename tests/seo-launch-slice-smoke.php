...
$expected=array_merge($turkeyExpected,$secondWaveExpected);
...
// Original Turkey sitemap helper remains stable for rollback/compatibility.
...
// hotel-tour candidate, the publication manifest must still refuse the page type.
$roguePath='/country/turkey/hotel/rogue-hotel-999999/';
$rogue=$turkeyCatalog;
$sourcePage=$turkeyCatalog['registry']['/country/turkey/']['page']??null;
...
echo "SEO_LAUNCH_SLICE_OK paths=8 turkey=6 secondWave=2 indexGate=1 sitemapGate=1 noSearchLeak=1 hotelTours=0\n";
