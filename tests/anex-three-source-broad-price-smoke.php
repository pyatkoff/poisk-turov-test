...
broad_check(ANEX_BROAD_PRICE_EXPERIMENT==='anex_three_source_broad_price_20260912_v6');
broad_check(ANEX_BROAD_PRICE_DATE==='2026-10-05');
$base=['experiment_id'=>ANEX_BROAD_PRICE_EXPERIMENT,'case_id'=>'anex','country'=>'Turkey','date'=>ANEX_BROAD_PRICE_DATE,'nights'=>8,'adults'=>2,'child_ages'=>[],'meal_family'=>'ai','currency'=>'RUB'];
...
foreach([['date','2026-10-06'],['country','Egypt'],['nights',7],['adults',1],['meal_family','bb'],['currency','USD'],['case_id','bad']] as [$key,$value]){$v=$base;$v[$key]=$value;try{anex_broad_price_input($v);broad_check(false);}catch(RuntimeException $e){broad_check($e->getMessage()==='BROAD_PRICE_INVALID_INPUT');}}
...
$row=anex_broad_price_offer('tourvisor',1239,1239,'HEDEF RESORT HOTEL',ANEX_BROAD_PRICE_DATE,8,2,0,'AI','Standard Room','DBL','107391','RUB','2500');
...
broad_check(anex_broad_price_offer('anex',0,8652,'X',ANEX_BROAD_PRICE_DATE,8,2,0,'AI','Standard','DBL','100000','RUB')===null);
broad_check(anex_broad_price_offer('anex',1239,8652,'X',ANEX_BROAD_PRICE_DATE,8,2,0,'BB','Standard','DBL','100000','RUB')===null);
broad_check(anex_broad_price_offer('anex',1239,8652,'X',ANEX_BROAD_PRICE_DATE,8,2,0,'UAI','Standard','DBL','100000','RUB')===null);
broad_check(anex_broad_price_offer('anex',1239,8652,'X',ANEX_BROAD_PRICE_DATE,8,2,0,'AI-WITHOUT ALCOHOL','Standard','DBL','100000','RUB')===null);
