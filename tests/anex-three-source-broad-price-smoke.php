...
broad_check(ANEX_BROAD_PRICE_EXPERIMENT==='anex_three_source_broad_price_20260911_v3');
broad_check(ANEX_BROAD_PRICE_DATE==='2026-10-19');
$base=['experiment_id'=>ANEX_BROAD_PRICE_EXPERIMENT,'case_id'=>'anex','country'=>'Egypt','date'=>ANEX_BROAD_PRICE_DATE,'nights'=>10,'adults'=>3,'child_ages'=>[],'meal_family'=>'ai','currency'=>'RUB'];
...
foreach([['date','2026-10-18'],['country','Turkey'],['nights',7],['adults',2],['meal_family','bb'],['currency','USD'],['case_id','bad']] as [$key,$value]){$v=$base;$v[$key]=$value;try{anex_broad_price_input($v);broad_check(false);}catch(RuntimeException $e){broad_check($e->getMessage()==='BROAD_PRICE_INVALID_INPUT');}}
...
$row=anex_broad_price_offer('tourvisor',1239,1239,'HEDEF RESORT HOTEL',ANEX_BROAD_PRICE_DATE,10,3,0,'AI','Standard Room','DBL','107391','RUB','2500');
...
broad_check(anex_broad_price_offer('anex',0,8652,'X',ANEX_BROAD_PRICE_DATE,10,3,0,'AI','Standard','DBL','100000','RUB')===null);
broad_check(anex_broad_price_offer('anex',1239,8652,'X',ANEX_BROAD_PRICE_DATE,10,3,0,'BB','Standard','DBL','100000','RUB')===null);
broad_check(anex_broad_price_offer('anex',1239,8652,'X',ANEX_BROAD_PRICE_DATE,10,3,0,'UAI','Standard','DBL','100000','RUB')===null);
broad_check(anex_broad_price_offer('anex',1239,8652,'X',ANEX_BROAD_PRICE_DATE,10,3,0,'AI-WITHOUT ALCOHOL','Standard','DBL','100000','RUB')===null);
