...
function anex_numeric_filter_reject(array $params, string $field, bool $value): void
{
    try {
    ...
    throw new RuntimeException('boolean accepted for ' . $field);
}
...
foreach (['hotelCategory', 'priceFrom', 'priceTo'] as $field) {
