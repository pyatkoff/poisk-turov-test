...
require_once dirname(__DIR__).'/scripts/diagnostics/hotel_match_samo_business_live30_common4_acquire_v3_wave2.php';

if(SLC4A_OP!=='hotel-match-samo-business-live30-common4-acquire-1971-20260924-v3-wave2')throw new RuntimeException('operation');
if(SLC4A_GROUP_START!==101||SLC4A_GROUP_END!==200)throw new RuntimeException('wave_bounds');
...
echo "MATCH_SAMO_BUSINESS_LIVE30_COMMON4_ACQUIRE_V3_WAVE2_TEST_OK\n";
