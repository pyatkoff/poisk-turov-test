...
$claim = [
    'country_id'=>4,'page_key'=>'month:1:4:2026-09','claim_key'=>'temperature-reference',
    'type'=>'climate_temperature','value'=>'fixture-value','source_class'=>'official_meteorological',
    'source_id'=>'tr-mgm-climate','source_url'=>'https://www.mgm.gov.tr/example','observed_at'=>'2026-08-01T00:00:00Z'
];
...
$bad=$claim; $bad['source_url']='https://meteorology.gov.mv/example'; if ((v2_seo_seasonal_verified_content_evidence([$bad],$now)['state']??'')!=='blocked') exit(4);
