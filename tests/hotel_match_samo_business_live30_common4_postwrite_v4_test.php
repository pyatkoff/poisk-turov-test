...
require_once __DIR__.'/../scripts/diagnostics/hotel_match_samo_business_live30_common4_postwrite_v4.php';
...
echo "MATCH_SAMO_BUSINESS_LIVE30_COMMON4_POSTWRITE_V4_TEST_OK\n";
