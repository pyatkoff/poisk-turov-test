...
require_once __DIR__.'/../scripts/diagnostics/hotel_match_tv_samo_common4_side_star4_v4.php';
...
hmc_need(str_contains($source,"'acquisition_scope'=>'fresh_full_pair_star4_only'"),'fresh_pair_scope');

echo "MATCH_TV_SAMO_COMMON4_SIDE_STAR4_V4_TEST_OK\n";
