...
require_once dirname(__DIR__).'/scripts/diagnostics/hotel_match_samo_business_live30_common4_wave5_recovery_acquire_v15.php';

if(SLC4A_OP!=='hotel-match-samo-business-live30-common4-wave5-recovery-acquire-1971-20260925-v15')throw new RuntimeException('operation');
if(SLC4A_GROUP_START!==401||SLC4A_GROUP_END!==502)throw new RuntimeException('wave_bounds');
...
echo "MATCH_SAMO_BUSINESS_LIVE30_COMMON4_WAVE5_RECOVERY_ACQUIRE_V15_TEST_OK\n";
