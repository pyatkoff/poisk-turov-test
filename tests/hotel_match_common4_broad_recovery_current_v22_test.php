...
require_once dirname(__DIR__).'/scripts/diagnostics/hotel_match_common4_broad_recovery_current_v22.php';
if(SBLC4C4_OP!=='hotel-match-common4-broad-recovery-current-1971-20260925-v22')throw new RuntimeException('operation');
if(SBLC4C4_SOURCE_OP!=='hotel-match-common4-broad-recovery-acquire-1971-20260925-v21')throw new RuntimeException('source_operation');
if(SBLC4C4_EXPECTED_EDGES!==4902||SBLC4C4_EXPECTED_CAPTURED!==77)throw new RuntimeException('counts');
$edges=[
...
echo "MATCH_COMMON4_BROAD_RECOVERY_CURRENT_V22_TEST_OK\n";
