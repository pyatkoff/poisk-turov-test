...
class ParseTest(unittest.TestCase):
    ...
    def test_anex_range(self):
        v=m.parse_command(
            f'/run-int-server-v1 {SHA} anex-range int-anex-mow-turkey-range-20260924-v2 '
        ...
        kids=m.parse_command(
            f'/run-int-server-v1 {SHA} anex-range int-anex-mow-turkey-family-20260924-v2 '
        ...
        bad=[
            f'/run-int-server-v1 {SHA} anex-range int-andromeda-bad-range-20260924-v2 1 4 2026-09-29 2026-10-19 7 2 - - 0',
            f'/run-int-server-v1 {SHA} anex-range int-anex-bad-range-20260924-v2 1 4 2026-10-19 2026-09-29 7 2 - - 0',
            f'/run-int-server-v1 {SHA} anex-range int-anex-bad-range-20260924-v2 1 4 2026-09-29 2026-10-20 7 2 - - 0',
            f'/run-int-server-v1 {SHA} anex-range int-anex-bad-range-20260924-v2 1 4 2026-09-29 2026-10-19 7 2 18 - 0',
            f'/run-int-server-v1 {SHA} anex-range int-anex-bad-range-20260924-v2 1 4 2026-09-29 2026-10-19 7 2 1,2,3,4 - 0',
        ]
        for value in bad:
