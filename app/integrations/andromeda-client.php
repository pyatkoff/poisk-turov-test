...
final class AnyTourAndromedaClient
{
    ...
    public static function validatePriceParams(array $params): void
    {
        ...
        if (array_diff($required,array_keys($params)) || array_diff(array_keys($params),array_merge($required,['MEAL','STARS','OPERATORS','AGES','HOTELS']))) throw new InvalidArgumentException('ANDROMEDA_INVALID_PARAMS');
