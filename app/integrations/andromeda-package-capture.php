...
final class AnyTourAndromedaPackageCapture
{
    ...
    private const SAFE_PACKAGE_FAILURE_CODES = [
    ...
    private static function safePackageFailureCode(Throwable $error): string
    {
        $code = $error->getMessage();
        return in_array($code, self::SAFE_PACKAGE_FAILURE_CODES, true)
            ? $code
