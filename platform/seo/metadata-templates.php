...
return [
    'country' => [
        'title' => 'Туры в {country_name} — цены {year} | AnyTour',
    ...
    'departure_country' => [
        'title' => 'Туры в {country_name} из {departure_name_genitive} — цены {year} | AnyTour',
        'description' => 'Туры в {country_name} с вылетом из {departure_name_genitive}: актуальные цены, даты и отели. Поиск туров AnyTour.',
        'h1' => 'Туры в {country_name} из {departure_name_genitive}',
