...
The live search journey through results → tour variant → selected-tour → return remains production-stable. Homepage, editorial routes and representative country pages share the canonical DS2 header/footer shell. Country hero resort badges now follow the same 44 px vertical rhythm at 375/430/768/1024/1440; they remain informational labels and are not a new interaction surface.

Continue the shared country/editorial shell re-audit at 375/430/768/1024/1440, focusing next on confirmed real CTA hierarchy/wrapping inconsistencies and the country/editorial → `/poisk-turov/` handoff across `/`, `/hot/`, `/contacts/`, `/how-to-buy/`, `/rb/`, `/country/` and representative country detail pages. Prefer shared-owner fixes only when a defect is confirmed. Do not turn resort labels into links/controls or invent new interaction behavior without an approved design/data contract. Do not invent route-local visual layers or implement a new unapproved layout; new design concepts stay in the owner-approval loop.

Whole-product site-wide score remains **7.3/10**. PR #800 improves country-detail DS2 geometry and five-width consistency, but it is a narrow visual-rhythm repair rather than the visible CTA/handoff convergence required for the next whole-product score increase.
