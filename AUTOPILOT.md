...
Next: continue search/results-first convergence. Inspect the results toolbar, hotel/tour-card hierarchy and selected-tour handoff at 768/1024/1440 for confirmed DS2 wrapping, overflow or search-generation defects. In parallel, visually sample `/country/`, `/country/turkey/` and another representative country page at 375/430/768/1024/1440. Do not change `/hot/` or `/how-to-buy/` again without a new confirmed defect.
