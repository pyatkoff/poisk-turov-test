...
1. Finish exhaustive `CI_WORKFLOW_AUDIT.md`, including remaining meal/visual/live/content/catalog/search/tour/mobile workflow families with explicit trigger, tier, contract and disposition for every workflow.
...
Preserve mature search/recovery/results/comparison/flight/price/fuel/lead behavior while this technical pass proceeds. Do not refactor merely for style and do not invent defects. Existing visual/product PRs that are unrelated to this phase remain deferred unless they fix a higher-priority confirmed production/user-journey problem.
