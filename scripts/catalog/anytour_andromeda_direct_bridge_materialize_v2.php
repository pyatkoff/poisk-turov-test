<?php
/** One-shot bounded materialization of the NEXT CURRENT accepted Andromeda identities onto existing AnyTour profiles. */
declare(strict_types=1);
require_once __DIR__ . '/../../v2/data/anytour-provider-identity-bridge-v1.php';

const ANYTOUR_ANDROMEDA_BRIDGE_OPERATION = 'local-andromeda-direct-bridge-materialize-2690-20260917-v2';
const ANYTOUR_ANDROMEDA_BRIDGE_SOURCE = '64b1ae457371905bc4a2159b360b5dff5fadfd3c';
...
function anytour_andromeda_direct_materialize(PDO $pdo, int $limit, DateTimeImmutable $now, callable $checkpoint): array
{
    ...
    if ((int)$pdo->query("SELECT GET_LOCK('anytour-andromeda-direct-bridge-2690-v2',0)")->fetchColumn() !== 1) {
    ...
    try {
        ...
        $pdo->query("SELECT RELEASE_LOCK('anytour-andromeda-direct-bridge-2690-v2')");
    }
}
