...
if owner.get('active_mode')!=expected_mode or owner.get('active_phase')!=expected_phase: errors.append('owner phase drift')
...
if state.get('mode')!=expected_mode or state.get('phase')!=expected_phase: errors.append('state phase drift')
