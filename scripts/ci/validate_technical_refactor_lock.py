...
if owner.get('active_mode')!='ux_visual' or owner.get('active_phase')!=expected_phase or owner.get('current_stage')!=expected_stage: errors.append('owner visual stage drift')
if state.get('mode')!='ux_visual' or state.get('phase')!=expected_phase or (state.get('current_stage') or {}).get('id')!=expected_stage: errors.append('state visual stage drift')
if errors:
