...
if ($argc !== 3) { fwrite(STDERR, "Usage: int_andromeda_selected_flight_proof_v2.php <site-root> <source-sha>\n"); exit(2); }
...
if ($selection === null || !is_array($selectedState)) {
...
$sidecarPath = $directory . '/' . $ref . '-' . $created . '-'
    . $selection['page'] . '-' . $selection['offer_ref'] . '-surcharge-v1.json';
...
$result = [
    ...
    'scope' => [
        ...
        'date_from' => '2026-10-20', 'date_to' => '2026-10-20',
