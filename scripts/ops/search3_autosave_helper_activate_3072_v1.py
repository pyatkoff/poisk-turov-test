...
BASE = '29a590fec2b48428e60d484873b53f065a3d776e'
SOURCE = 'b8f1607c46333dc8931f246a19428ec15afddcdb'
OP = 'search3-autosave-helper-3072-20260919-v1'
BRANCH = 'ops/' + OP
CLAIM = 5743495312
...
PATHS = ['.github/workflows/search3-autosave-helper-activate-3072-v1.yml',
         'scripts/ops/search3_autosave_helper_activate_3072_v1.py']
...
def authorize(wait_security):
    ...
    need(source_pr.get('merged') is True and source_pr['head']['sha'] == SOURCE and source_pr['merge_commit_sha'] == '25d03f7317350652129231223eccbd865b7a912b', 'merged_source')
