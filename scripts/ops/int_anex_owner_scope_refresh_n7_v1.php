...
$argv = [$collector, '--departure=1', '--country=4', '--date-from=2026-09-18', '--date-to=2026-09-24', '--nights=7', '--adults=2', '--max-expands=60', '--max-apd=300', '--generation=25061971'];
$argc = count($argv);
ob_start();
...
echo json_encode(['status'=>'completed','provider'=>'anex','scope'=>['departure_id'=>1,'country_id'=>4,'date_from'=>'2026-09-18','date_to'=>'2026-09-24','nights'=>7,'adults'=>2,'children'=>0,'meal'=>''],'collector'=>$result,'booking_calls'=>0,'lead_calls'=>0,'mapping_writes'=>0,'search3_publication'=>0,'production_webroot_writes'=>0,'replay_allowed'=>false], JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES|JSON_THROW_ON_ERROR), "\n";
