...
$argv=[
    ...
    '--date-from=2026-10-13','--date-to=2026-10-19',
    '--nights=7','--adults=2','--meal=7',
    '--max-expands=60','--max-apd=300','--generation=25061851',
];
$argc=count($argv);
ob_start();
...
$result=[
    ...
    'scope'=>['departure_id'=>1,'country_id'=>4,'date_from'=>'2026-10-13','date_to'=>'2026-10-19','nights'=>7,'adults'=>2,'meal'=>'7'],
