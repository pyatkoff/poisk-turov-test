...
def main() -> None:
    ...
    if args.parse_only:
        for key,value in command.items():
            print(f'{key}={value}')
        return
    if command['mode'] in ('anex-range','match-tv942','match-samo942','match-tv234-secondary','match-common4-acquire','match-common4-continuation-acquire','match-common4-continuation-resume-day','program-fuel-probe'):
