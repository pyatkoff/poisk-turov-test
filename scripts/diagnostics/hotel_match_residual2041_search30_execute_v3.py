...
from hotel_match_residual2041_search30_provider_v3 import OP,OPS,Provider,ident,link_state,num,ready,rows,save,unwrap
MAX_CONTINUE=0
...
def selftest():
 ...
 print('SEARCH30_EXEC_V3_SELFTEST_OK')
