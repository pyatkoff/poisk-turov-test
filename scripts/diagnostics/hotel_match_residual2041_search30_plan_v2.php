...
if(($argv[1]??'')==='--self-test'){if(count(array_chunk(range(1,61),30))!==3)throw new RuntimeException('chunk');$x=attempted(['batches'=>[['hotel_ids'=>[1,2]],['hotel_ids'=>[3]]]]);if(array_keys($x)!==[1,2,3])throw new RuntimeException('attempted');echo "SEARCH30_PLAN_V2_SELFTEST_OK\n";exit;}
