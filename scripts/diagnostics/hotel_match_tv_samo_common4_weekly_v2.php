...
const HMC_OP = 'hotel-match-tv-samo-common4-weekly-1971-20260922-v2';
...
function hmc_execute(string $root,string $opDir,string $user,string $pass): array {
    ...
    $region=hmc_dict($tvRegions,['Сиде','Side']);
    ...
    $town=hmc_dict($all['TOWNTO'],['Сиде','Side']);
    ...
    $date=HMC_DATE_FROM;$dateTo=HMC_DATE_TO;
    $weekDates=hmc_week_dates();
    $ymd=str_replace('-','',$date);$ymdTo=str_replace('-','',$dateTo);
