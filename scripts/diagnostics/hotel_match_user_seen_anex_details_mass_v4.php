...
const HMA_OP='hotel-match-user-seen-anex-details-mass-1971-20260918-v4';
...
if(in_array('--self-test',$argv??[],true)){if(hma_key('Porto Bello Hotel Resort & Spa')!=='bello porto')throw new RuntimeException('key');if(hma_score('Ozkaymak Falez Hotel','OZKAYMAK FALEZ HOTEL')<95)throw new RuntimeException('score');if(hma_tokens(123)!==[]||hma_tokens('123')!==[])throw new RuntimeException('numeric_only_guard');if(hma_tokens('7Pines Resort')===[])throw new RuntimeException('alphanumeric_name_guard');echo"ANEX_MASS_DETAILS_SELFTEST_OK\n";exit;}
