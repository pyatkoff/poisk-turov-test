...
const OP='hotel-match-remaining-tv-search30-1971-20260921-v4';
...
if(($argv[1]??'')==='--self-test'){if(count(array_chunk(range(1,61),30))!==3)throw new RuntimeException('chunk');$x=attempted(['attempted_batches'=>[['hotel_ids'=>[1,2]]]]);if(array_keys($x)!==[1,2])throw new RuntimeException('attempted');echo "REMAINING_SEARCH30_PLAN_V4_SELFTEST_OK\n";exit;}
