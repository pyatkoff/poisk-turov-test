...
const OP='int-anex-page2-current-20260919-v1';
...
function main(string$root,string$ledger):array{
 $_SERVER['DOCUMENT_ROOT']=$root;$preview=$root.'/_preview/search3-anex-candidate';$api=$preview.'/api-anex-search3-preview.php';if(!is_file($api)||is_link($api))throw new RuntimeException('API_RUNTIME');require_once$api;
