...
from hotel_match_remaining_tv_search30_provider_v1 import OP,OPS,Provider,ident,link_state,num,ready,rows,save,unwrap
MAX_CONTINUE=0
...
def selftest():
 ...
 print('REMAINING_SEARCH30_EXEC_V1_SELFTEST_OK')
