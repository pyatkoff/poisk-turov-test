...
def main():
    ...
    php=(root/'app/integrations/andromeda-hotel-observations.php').read_text().removeprefix('<?php')
    php+='\n'+(root/'scripts/diagnostics/andromeda-observations-install.php').read_text().removeprefix('<?php')
