...
function v39_place_key(mixed $v):string{$n=v39_norm($v);$n=preg_replace('/\b(?:центр|center|centre|город|city|остров|island)\b/u',' ',$n)??$n;return trim(preg_replace('/\s+/u',' ',$n)??$n);}
