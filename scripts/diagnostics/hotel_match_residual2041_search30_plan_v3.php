...
const OP='hotel-match-residual2041-search30-common4-1971-20260921-v3';
...
if(($argv[1]??'')==='--self-test'){if(count(array_chunk(range(1,61),30))!==3)throw new RuntimeException('chunk');$x=attempted(['batches'=>[['hotel_ids'=>[1,2]],['hotel_ids'=>[3]]]]);if(array_keys($x)!==[1,2,3])throw new RuntimeException('attempted');echo "SEARCH30_PLAN_V3_SELFTEST_OK\n";exit;}
