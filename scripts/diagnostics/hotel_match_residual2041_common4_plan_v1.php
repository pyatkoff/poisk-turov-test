...
const OP='hotel-match-residual2041-common4-nonanex-detail-1971-20260921-v1';
...
if(($src['operation']??'')!=='hotel-match-userseen-canonical-census-1971-20260920-v1')throw new RuntimeException('input_operation');
$residual=[];
