...
const HMTV_OP='hotel-match-user-seen-tv-detail-saturation-1971-20260918-v1';
...
function hmtv_http_once(string $token,string $tourId): array {
    ...
    try{
        curl_setopt_array($ch,[
            ...
            CURLOPT_PROXY=>'',CURLOPT_NOPROXY=>'*',CURLOPT_USERAGENT=>'AnyTour-MATCH-TV-detail-saturation/1.0',
