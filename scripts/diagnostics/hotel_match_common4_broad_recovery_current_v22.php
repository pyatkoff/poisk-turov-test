...
const SBLC4C4_OP='hotel-match-common4-broad-recovery-current-1971-20260925-v22';
const SBLC4C4_SOURCE_OP='hotel-match-common4-broad-recovery-acquire-1971-20260925-v21';
const SBLC4C4_PLAN_OP='hotel-match-samo-business-live30-common4-plan-1971-20260924-v2';
const SBLC4C4_EXPECTED_EDGES=4902;
const SBLC4C4_EXPECTED_CAPTURED=77;
...
function sb4_source_edges(array $source,string $sourceResultSha):array{
    ...
    sb4_need((int)($source['context_count']??0)===16&&(int)($source['failed_state_operator_count']??-1)===0,'source_context_counts');
    sb4_need((int)($source['single_native_source_collision_count']??-1)===0,'source_native_collision');
    sb4_need((int)($source['provider_http_calls']??0)===32&&(int)($source['samo_http_calls']??0)===32,'source_samo_calls');
    sb4_need(($source['edge_state_counts']??null)===['captured_single_native'=>77,'not_returned_in_context'=>4825],'source_edge_states');
...
if(PHP_SAPI==='cli'&&realpath($_SERVER['SCRIPT_FILENAME']??'')===__FILE__){
    if(in_array('--self-test',$argv??[],true)){sb4_self_test();echo "MATCH_COMMON4_BROAD_RECOVERY_CURRENT_V22_SELFTEST_OK\n";exit;}
