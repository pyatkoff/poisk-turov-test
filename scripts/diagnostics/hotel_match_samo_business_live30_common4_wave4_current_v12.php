...
const SBLC4C4_OP='hotel-match-samo-business-live30-common4-wave4-current-1971-20260925-v12';
const SBLC4C4_SOURCE_OP='hotel-match-samo-business-live30-common4-acquire-1971-20260924-v3-wave4';
const SBLC4C4_PLAN_OP='hotel-match-samo-business-live30-common4-plan-1971-20260924-v2';
const SBLC4C4_EXPECTED_EDGES=1197;
const SBLC4C4_EXPECTED_CAPTURED=22;
...
function sb4_source_edges(array $source,string $sourceResultSha):array{
    ...
    sb4_need((int)($source['global_group_count']??0)===502&&(int)($source['group_start']??0)===301&&(int)($source['group_end']??0)===400,'source_group_scope');
    ...
    sb4_need((int)($source['samo_http_calls']??0)===107,'source_samo_calls');
