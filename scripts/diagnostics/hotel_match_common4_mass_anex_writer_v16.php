...
const HMCMAW_OP='hotel-match-common4-mass-anex-writer-1971-20260924-v16';
...
if(PHP_SAPI==='cli'&&realpath($_SERVER['SCRIPT_FILENAME']??'')===__FILE__){
 $mode=$argv[1]??'';if($mode==='--self-test'){echo "MATCH_COMMON4_MASS_ANEX_WRITER_V16_SELFTEST_OK\n";exit;}hmcmaw_need($mode==='--execute','disabled');
