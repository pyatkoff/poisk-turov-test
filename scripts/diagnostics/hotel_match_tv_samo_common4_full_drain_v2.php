...
const HMC2_OP = 'hotel-match-tv-samo-common4-full-drain-1971-20260918-v2';
...
if(in_array('--self-test',$argv??[],true)){
    ...
    if(!is_array($dates))throw new RuntimeException('v2_window');
    $mock=['items'=>[['id'=>1,'name'=>'RUB']]];
    if(hmc2_dict_id($mock,['RUB'])!==1)throw new RuntimeException('v2_dict');
    echo "MATCH_TV_SAMO_COMMON4_FULL_DRAIN_V2_SELFTEST_OK\n";exit(0);
}
