...
const HMAC_OP='hotel-match-user-seen-anex-live-context-discovery-1971-20260918-v4';
...
if(in_array('--self-test',$argv??[],true)){
  ...
  if(hmac_dict_id([['id'=>1,'name'=>'Moscow'],['id'=>2,'name'=>'Other']],hmac_departure_aliases('Москва'))!==1)throw new RuntimeException('dict');if(!in_array('с петербург',hmac_departure_aliases('С.Петербург'),true)||count(HMAC_PRIOR_CONTEXTS)!==45)throw new RuntimeException('batch2_scope');
  ...
  echo"ANEX_LIVE_CONTEXT_DISCOVERY_V4_SELFTEST_OK\n";exit;
}
