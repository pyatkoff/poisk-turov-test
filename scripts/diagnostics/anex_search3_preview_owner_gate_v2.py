#!/usr/bin/env python3
"""Pure authorization gate for the v2 ANEX Search3 preview publication."""
...
def main() -> int:
    ...
    try:
        ...
        print("ANEX_PREVIEW_V2_CONTROL_DENIED invalid_event", file=sys.stderr)
        return 1
    allowed, reason = authorize(event, dict(os.environ))
    if not allowed:
        print("ANEX_PREVIEW_V2_CONTROL_DENIED " + reason, file=sys.stderr)
        return 1
    print("ANEX_PREVIEW_V2_CONTROL_AUTHORIZED")
    return 0
