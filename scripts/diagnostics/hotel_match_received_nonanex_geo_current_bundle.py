#!/usr/bin/env python3
"""Build one immutable read-only CURRENT pass with conservative target-side geo-edge aliases."""
...
OPERATION_ID = "hotel-match-received-nonanex-geo-current-1971-20260916-v1"
