...
function opl_apply(string $dir,string $sourceSha): void {
    ...
    try {
        ...
        $phase='commit';$db->commit();$committed=true;opb_write($dir.'/committed.json',['operation_id'=>OPL_OP,'source_sha'=>$sourceSha,'rows'=>count($plan),'state'=>'committed_before_readback']);
