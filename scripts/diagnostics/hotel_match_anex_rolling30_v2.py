#!/usr/bin/env python3
"""Bounded MATCH hotel-identity acquisition v2. Never drains a search or writes mappings."""
import collections, datetime as dt, fcntl, hashlib, json, os, pathlib, re, subprocess, sys, time
import urllib.error, urllib.parse, urllib.request
from zoneinfo import ZoneInfo

OP='hotel-match-anex-rolling30-1971-20260919-v2'
DAY='2026-09-19'
LIMIT=3000
KNOWN_FLOOR=689
CALL_CAP=180
...
def execute(opdir,root):
    ...
    cp=subprocess.run(['php',str(opdir/'payload/hotel_match_anex_rolling30_current_v2.php'),'--execute'],capture_output=True,check=False)
...
def selftest():
    ...
    print('ROLLING30_V2_SELFTEST_OK: prior_residual_once, refill, no_continue, signed-token-hold, durable-no-replay')
