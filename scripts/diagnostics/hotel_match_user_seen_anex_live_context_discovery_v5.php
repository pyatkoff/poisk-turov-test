...
const HMAC_OP='hotel-match-user-seen-anex-live-context-discovery-1971-20260918-v5';
...
const HMAC_PRIOR_CONTEXTS=['1|4|2026-09-18|7'=>true,'1|4|2026-09-22|7'=>true,'1|13|2026-10-01|6'=>true,'1|13|2026-11-15|10'=>true,'1|4|2026-09-19|7'=>true,'1|13|2026-12-10|10'=>true,'1|79|2026-10-02|7'=>true,'9|13|2026-11-01|7'=>true,'1|56|2026-09-19|5'=>true,'1|56|2026-09-20|5'=>true,'1|79|2026-12-28|6'=>true,'1|27|2026-10-28|7'=>true,'1|16|2026-09-30|8'=>true,'1|16|2027-01-27|15'=>true,'1|79|2027-01-02|8'=>true,'1|16|2026-09-30|10'=>true,'1|8|2026-10-14|5'=>true,'1|5|2026-10-29|7'=>true,'1|8|2026-09-23|5'=>true,'1|8|2026-10-19|5'=>true,'1|3|2026-11-24|11'=>true,'9|16|2026-11-04|7'=>true,'1|9|2026-12-10|9'=>true,'9|13|2026-11-05|7'=>true,'9|13|2026-11-01|8'=>true,'1|1|2026-10-05|7'=>true,'9|2|2026-11-04|7'=>true,'1|3|2027-01-05|8'=>true,'1|23|2026-09-21|7'=>true,'9|16|2027-02-06|7'=>true,'9|16|2026-10-30|7'=>true,'1|3|2026-12-30|7'=>true,'1|1|2027-01-02|8'=>true,'1|2|2027-01-15|9'=>true,'1|1|2026-09-25|6'=>true,'9|2|2026-11-04|6'=>true,'1|2|2026-09-20|7'=>true,'7|4|2026-10-05|6'=>true,'22|2|2026-11-14|7'=>true,'1|27|2026-10-28|6'=>true,'1|2|2026-09-20|8'=>true,'5|9|2026-11-25|7'=>true,'1|9|2026-11-10|7'=>true,'3|4|2026-09-30|6'=>true,'3|4|2026-09-30|7'=>true,'1|4|2026-09-20|7'=>true,'1|4|2026-09-24|7'=>true,'1|4|2026-10-05|7'=>true,'1|13|2026-10-01|4'=>true,'1|13|2026-11-15|7'=>true,'1|16|2026-09-18|6'=>true,'1|79|2026-12-28|7'=>true,'1|79|2026-12-28|8'=>true,'1|8|2026-09-21|5'=>true,'1|8|2026-10-07|5'=>true,'1|79|2027-01-02|7'=>true,'1|8|2026-10-02|5'=>true,'1|16|2027-01-01|8'=>true,'1|16|2026-09-27|10'=>true,'1|3|2026-11-24|12'=>true,'1|3|2026-11-27|12'=>true,'4|16|2026-11-07|10'=>true,'20|13|2026-09-29|7'=>true,'5|16|2026-10-15|9'=>true,'1|3|2026-11-28|11'=>true,'1|1|2026-10-05|8'=>true,'1|1|2026-09-18|8'=>true,'1|2|2027-01-25|9'=>true,'1|41|2026-09-20|7'=>true,'4|2|2027-02-19|11'=>true,'1|41|2026-09-19|7'=>true,'1|41|2026-09-19|8'=>true,'9|2|2026-10-30|7'=>true,'4|4|2026-10-05|12'=>true,'1|1|2026-11-01|7'=>true,'1|9|2026-12-28|6'=>true,'1|9|2026-12-10|10'=>true,'1|2|2027-02-18|7'=>true,'7|2|2026-11-11|11'=>true,'1|23|2026-09-18|8'=>true,'3|4|2026-09-30|8'=>true,'22|16|2026-10-23|12'=>true,'1|2|2026-09-20|9'=>true,'5|4|2026-10-04|9'=>true,'1|9|2026-12-28|7'=>true,'1|23|2026-09-22|8'=>true,'5|1|2026-09-27|9'=>true,'5|9|2026-10-28|9'=>true,'5|9|2026-10-05|7'=>true,'5|9|2026-10-06|7'=>true];
const HMAC_PRIOR_LOCAL_IDS=[3061=>true,3080=>true,3086=>true,3087=>true,3097=>true,3103=>true,3109=>true,4058=>true,4087=>true,8356=>true,8371=>true,8928=>true,11771=>true,11802=>true,11805=>true,11806=>true,13921=>true,37222=>true,37936=>true,38702=>true,41772=>true,57720=>true,60002=>true,60004=>true,60837=>true,60874=>true,64350=>true,65633=>true,67098=>true,68586=>true,68733=>true,128538=>true,159711=>true];
...
function hmac_product(string $name):bool{
  $raw=mb_strtolower(trim($name),'UTF-8');$n=hmac_norm($name);
  if(preg_match('/^(roulette|рулетка)(\\s|$)/u',$n))return true;
...
function hmac_place(array $detail,array $local):bool{$src=[];foreach(['state','region','town','address']as$k){$n=hmac_norm((string)($detail[$k]??''));if($n!=='')$src[]=$n;}$dst=[];foreach(['region_name','subregion_name']as$k){$n=hmac_norm((string)($local[$k]??''));if($n!=='')$dst[]=$n;}foreach($src as$a)foreach($dst as$b)if($a===$b||str_contains($a,$b)||str_contains($b,$a))return true;return false;}
function hmac_detail(array $p):array{return['id'=>(string)($p['id']??$p['hotelKey']??''),'name'=>(string)($p['name']??$p['hotel']??''),'country'=>(string)($p['country']??''),'state'=>(string)($p['state']??''),'region'=>(string)($p['region']??''),'town'=>(string)($p['town']??''),'address'=>(string)($p['address']??''),'latitude'=>$p['latitude']??null,'longitude'=>$p['longitude']??null,'townKey'=>(string)($p['townKey']??'')];}
...
function hmac_saved_detail(array $r):array{return['id'=>(string)($r['anex_hotel_id']??''),'name'=>(string)($r['api_name']??$r['xml_name']??''),'country'=>(string)($r['api_country']??''),'state'=>(string)($r['api_region']??''),'region'=>(string)($r['api_region']??''),'town'=>(string)($r['api_town']??''),'address'=>'','latitude'=>$r['latitude']??null,'longitude'=>$r['longitude']??null,'townKey'=>''];}
...
if(in_array('--self-test',$argv??[],true)){
  ...
  if(hmac_dict_id([['id'=>1,'name'=>'Moscow'],['id'=>2,'name'=>'Other']],hmac_departure_aliases('Москва'))!==1)throw new RuntimeException('dict');if(!in_array('с петербург',hmac_departure_aliases('С.Петербург'),true)||count(HMAC_PRIOR_CONTEXTS)!==90||count(HMAC_PRIOR_LOCAL_IDS)!==33)throw new RuntimeException('batch3_scope');
  ...
  echo"ANEX_LIVE_CONTEXT_DISCOVERY_V5_SELFTEST_OK\n";exit;
}
...
$build=function()use($db):array{
  ...
  try{
    ...
    foreach($contextRows as$r){$dep=(int)$r['departure_id'];$cid=(int)$r['country_id'];$ctxKey=$dep.'|'.$cid.'|'.(string)$r['departure_date'].'|'.(int)$r['nights'];if(isset(HMAC_PRIOR_CONTEXTS[$ctxKey]))continue;if(!isset($deps[$dep],$countries[$cid])||isset(HMAC_EXCLUDED_COUNTRIES[$cid]))continue;$pair=$dep.'|'.$cid;if(($pairCount[$pair]??0)>=3||($countryCount[$cid]??0)>=6)continue;$contexts[]=['departure_id'=>$dep,'departure_name'=>$deps[$dep],'country_id'=>$cid,'country_name'=>$countries[$cid],'date'=>(string)$r['departure_date'],'nights'=>(int)$r['nights'],'hotel_weight'=>(int)$r['hotels'],'observation_weight'=>(int)$r['obs']];$pairCount[$pair]=($pairCount[$pair]??0)+1;$countryCount[$cid]=($countryCount[$cid]??0)+1;if(count($contexts)>=HMAC_MAX_CONTEXTS)break;}
...
foreach($preCandidates as$c){$ext=$c['external_id'];$lid=$c['local_id'];$local=$state['frontier'][$lid];$d=$details[$ext]??null;if(!is_array($d)||isset($d['error'])){$holds[]=$c+['reason'=>'detail_unavailable'];continue;}
  $explicitCountry=trim((string)($d['country']??''));if($explicitCountry!==''&&hmac_country_key($explicitCountry)!==hmac_country_key((string)$local['country_name'])){$holds[]=$c+['reason'=>'detail_country_conflict','detail_country'=>$explicitCountry,'detail_state'=>(string)($d['state']??''),'detail_source'=>$detailSource[$ext]??null];continue;}
  ...
  $row=$c+['detail_name'=>(string)$d['name'],'detail_country'=>(string)($d['country']??''),'detail_state'=>(string)($d['state']??''),'detail_region'=>(string)$d['region'],'detail_town'=>(string)$d['town'],'detail_source'=>$detailSource[$ext]??null,'detail_score'=>$nb['score'],'exact_name'=>$exact,'distance_m'=>$dist===null?null:(int)round($dist),'place_match'=>$place,'user_observations'=>(int)$local['obs']];
