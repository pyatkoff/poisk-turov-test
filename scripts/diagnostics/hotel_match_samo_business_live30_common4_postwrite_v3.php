...
const SBLC4_OP='hotel-match-samo-business-live30-common4-postwrite-1971-20260924-v3';
...
if(PHP_SAPI==='cli'&&realpath($_SERVER['SCRIPT_FILENAME']??'')===__FILE__){
    if(in_array('--self-test',$argv??[],true)){$x=sblc4_canonical_catalog([['andromeda_catalog','10'],['operator_115','b']],[ 'operator_115|b'=>[7=>true]],[7=>['10'=>true]]);sblc4_need(count($x['catalog'])===1&&isset($x['catalog']['10'])&&$x['operator_resolved']===1,'canonical');echo"MATCH_SAMO_BUSINESS_LIVE30_COMMON4_POSTWRITE_V3_SELFTEST_OK\n";exit;}
