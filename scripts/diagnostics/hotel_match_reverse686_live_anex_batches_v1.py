...
OP='hotel-match-reverse686-live-anex-batches-1971-20260920-v1';DAY='2026-09-20';LIMIT=3000;CALL_CAP=500;BASE='https://api.tourvisor.ru/search/api/v1';BODY_LIMIT=16*1024*1024
...
def execute(root,opdir,inputp):
 ...
 if res['operation']!=OP or len(inp.get('rows',[]))!=686:raise RuntimeError('input_guard')
 groups={}
 for x in inp['rows']:
 ...
 save(opdir/'plan.json',{'operation':OP,'groups':len(plan),'hotels':686,'plan':plan})
...
def selftest():print('REVERSE686_LIVE_SELFTEST_OK')
