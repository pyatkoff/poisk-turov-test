...
const SBLC4C4_OP='hotel-match-common4-retained-context-v26b-current-1971-20260925-v29';
...
if(PHP_SAPI==='cli'&&realpath($_SERVER['SCRIPT_FILENAME']??'')===__FILE__){
    if(in_array('--self-test',$argv??[],true)){sb4_self_test();echo "MATCH_COMMON4_RETAINED_CONTEXT_V26B_CURRENT_V29_SELFTEST_OK\n";exit;}
