...
const MANB_OP = 'hotel-match-accepted-name-bridge-review-1971-20260915-v3';
...
function manb_weak_key(string $raw,array $hotel): ?string {
    ...
    $hasAlpha=false;foreach($tokens as $t)if(preg_match('/\p{L}/u',(string)$t)){$hasAlpha=true;break;}if(!$hasAlpha)return'numeric_only';
    return null;
}
