...
const OP = 'hotel-match-biblio-probe2-1971-20260922-v1';
const TV = 1293;
const F4 = '102625934280';
const EXPECTED_SAVED_CANONICAL = '2000069021';
const EXCLUDED_PREVIOUS = [1096,1098,1102,1105,1108,1111,1113,1114,1118,1134,1137,1139,1140,1141,1143,1146,1161,1162,1177,1245,1246,1249,1250,1252,1257,1262,1273,1279,1282,1284,1292];
...
function selfTest(): void {
    need(TV===1293&&F4==='102625934280'&&EXPECTED_SAVED_CANONICAL==='2000069021','probe');
