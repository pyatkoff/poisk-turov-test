...
const SLC4A_OP='hotel-match-samo-business-live30-common4-acquire-1971-20260924-v3-wave3';
const SLC4A_GROUP_START=201;
const SLC4A_GROUP_END=300;
...
if(PHP_SAPI==='cli'&&realpath($_SERVER['SCRIPT_FILENAME']??'')===__FILE__){
    if(in_array('--self-test',$argv??[],true)){
        ...
        echo "MATCH_SAMO_BUSINESS_LIVE30_COMMON4_ACQUIRE_V3_WAVE3_SELFTEST_OK\n";exit;
    }
