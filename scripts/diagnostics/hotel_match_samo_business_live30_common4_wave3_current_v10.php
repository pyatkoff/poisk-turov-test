...
const SBLC4C4_OP='hotel-match-samo-business-live30-common4-wave3-current-1971-20260924-v10';
const SBLC4C4_SOURCE_OP='hotel-match-samo-business-live30-common4-acquire-1971-20260924-v3-wave3';
const SBLC4C4_PLAN_OP='hotel-match-samo-business-live30-common4-plan-1971-20260924-v2';
const SBLC4C4_EXPECTED_EDGES=1200;
const SBLC4C4_EXPECTED_CAPTURED=328;
...
function sb4_source_edges(array $source,string $sourceResultSha):array{
    ...
    sb4_need((int)($source['global_group_count']??0)===502&&(int)($source['group_start']??0)===201&&(int)($source['group_end']??0)===300,'source_group_scope');
    ...
    sb4_need((int)($source['samo_http_calls']??0)===183,'source_samo_calls');
...
if(PHP_SAPI==='cli'&&realpath($_SERVER['SCRIPT_FILENAME']??'')===__FILE__){
    if(in_array('--self-test',$argv??[],true)){sb4_self_test();echo "MATCH_SAMO_BUSINESS_LIVE30_WAVE3_CURRENT_V10_SELFTEST_OK\n";exit;}
