...
const HMMS_OP='hotel-match-tv-anex-missing-samo-frontier-1971-20260919-v1';
...
if(($argv[1]??'')==='--self-test'){
    ...
    hmms_req(array_keys($b)===['177152','2000060795'],'bridge_ids');
    hmms_req(hmms_positive_id('-1')===null&&hmms_positive_id('4158')==='4158','positive_id');
    echo "hotel-match-tv-anex-missing-samo-frontier-v1: PASS\n";exit(0);
}
