...
const HMSAJ_OP='hotel-match-live-samo-anex-identity-join-1971-20260925-v34';
...
function hmsaj_execute(PDO $db):array{
    ...
    try{
        ...
        hmsaj_need(count($frontier)===777,'frontier_changed');
...
if(PHP_SAPI==='cli'&&realpath($_SERVER['SCRIPT_FILENAME']??'')===__FILE__){
    ...
    if($mode==='--self-test'){
        ...
        echo "MATCH_LIVE_SAMO_ANEX_IDENTITY_JOIN_V34_SELFTEST_OK\n";exit;
    }
