...
const HMSA_OPERATION='hotel-match-user-seen-anex-saved-operatorlink-bridge-1971-20260918-v1';
...
function hmsa_native_evidence(array $row): array {
    ...
    $out=['status'=>'parsed','host'=>$p['host'],'path'=>$p['path'],'anex_online_ids'=>array_keys($ids['anex_online']),'samo_hotelcode_ids'=>array_keys($ids['samo_hotelcode']),'other_native_ids'=>array_keys($ids['other_native'])];
